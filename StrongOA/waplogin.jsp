...
/* common */
html{ color: #000; background:url(<%=root%>/oa/image/login/bgimg.png) #052c59 no-repeat center center; }
...
.login{ background:url(<%=root%>/oa/image/login/logbg.png) repeat-x center center; }
.logo{ padding-top:12px; text-align:center; }
.loginbar{ background:url(<%=root%>/oa/image/login/syhximg.png) no-repeat center 10px; padding-top:20px; }
.loginbar p{ margin:12px 0; text-align:center; }
p.logbts{ margin:0; height:20px; line-height:20px; text-align:center; color:#c00; }
p.logbarpa{ height:32px; }
p.logbarpa input{ width:150px; height:26px; line-height:26px; border:none; padding:3px; background:url(<%=root%>/oa/image/login/yhmbg.png) no-repeat 0 top; }
p.logbarpb{ height:32px; }
p.logbarpb input{ width:150px; height:26px; line-height:26px; border:none; padding:3px; background:url(<%=root%>/oa/image/login/yhmbg.png) no-repeat 0 top; }
p.logbarpc{ padding-top:8px; margin:0; height:62px; background:url(<%=root%>/oa/image/login/logkimg.png) no-repeat center 1px; text-align:center; }
p.logbarpc input{ width:200px; height:40px; background:none; border:none; }
p.logbarpa1{ height:40px; background:none; border:none; color:red; text-align:center; }
/* nav */
...
<div id="container">
  <div class="login">
    <div class="logo"><img style="width:250px;" src="<%=root%>/oa/image/login/logo.png" /></div>
    <div class="loginbar">
      <form name="form1" id="form1" method="post" action="<%=path%>/wap/login!validateLogin.action">
      <p class="logbarpa">用户名： <input type="text"  name="j_username" id="j_username" value="<%=username%>"/></p>
      <p class="logbarpb">密&nbsp;&nbsp;&nbsp;&nbsp;码： <input type="password" name="j_password" id="j_password"/></p>
     </form>	
    </div>

...
function selectBaseData(objId,objName,dictValue){
    ...
    var URLStr = scriptroot+"/dict/dictItem/dictItem!tree.action?objId="+objId+"&objName="+objName+"&dictCode="+dictValue;
...
function selectSalaryBaseArea(objId,objName,dictValue,flag){
	deptbudget_isOpenSelectWindow='1';
    var URLStr = scriptroot+"/lwc/common/mztree/action/InfoAreaSelAction.do?objId="+objId+"&objName="+objName+"&dictValue="+dictValue+"&flag="+flag;
	 var sty="dialogWidth:"+deptbudget_basedata_width+"px;dialogHeight:"+deptbudget_basedata_height+"px;status:no";
    if(deptbudget_basedata_popUpWin)
	{
              if(!deptbudget_basedata_popUpWin.closed) deptbudget_basedata_popUpWin.close();
...
function selectJTLXBaseArea(objId,objName,dictValue,value){
	deptbudget_isOpenSelectWindow='1';
    var URLStr = scriptroot+"/ipproot/personal/common/tree/action/InfoItemTreeAction.do?objId="+objId+"&objName="+objName+"&dictValue="+dictValue+"&flagvalue="+value;
	 var sty="dialogWidth:"+deptbudget_basedata_width+"px;dialogHeight:"+deptbudget_basedata_height+"px;status:no";
    if(deptbudget_basedata_popUpWin)
	{
              if(!deptbudget_basedata_popUpWin.closed) deptbudget_basedata_popUpWin.close();
...
function selectBaseArea(objId,objName){
	deptbudget_isOpenSelectWindow='1';
    var URLStr = scriptroot+"/ipproot/personal/common/tree/action/InfoAreaTreeAction.do?objId="+objId+"&objName="+objName;
	 var sty="dialogWidth:"+deptbudget_basedata_width+"px;dialogHeight:"+deptbudget_basedata_height+"px;status:no";
    if(deptbudget_basedata_popUpWin)
	{
              if(!deptbudget_basedata_popUpWin.closed) deptbudget_basedata_popUpWin.close();
...
function selectBaseCom(objId,objName){
	deptbudget_isOpenSelectWindow='1';
    var URLStr = scriptroot+"/ipproot/personal/common/tree/action/InfoComTreeAction.do?objId="+objId+"&objName="+objName;
	 var sty="dialogWidth:"+deptbudget_basedata_width+"px;dialogHeight:"+deptbudget_basedata_height+"px;status:no";
    if(deptbudget_basedata_popUpWin)
	{
              if(!deptbudget_basedata_popUpWin.closed) deptbudget_basedata_popUpWin.close();

			...
			<table width="100%" height="10%" border="0" cellpadding="0"
				...
				<tr>
					...
					<td class="td1" colspan="3" align="left">
						<input type="text" id="Application" size="30" value="请选择下列申请单"
							readonly="readonly" />
					</td>
				</tr>
				<tr>
					...
					<td class="td1" align="left">
						...
						<input type="button" id="selectRoom" value="选择会议室" />
					</td>
					<td height="21" class="biao_bg1" align="right">
...
<%--				window.parent.personal_content.personal_status_content.location="applicationList.jsp";--%>
<%--			});--%>
			$("#selectRoom").click(function(){
				window.parent.personal_content.personal_status_content.location="meetingRoomList.jsp";
			});
			$("#back").click(function(){

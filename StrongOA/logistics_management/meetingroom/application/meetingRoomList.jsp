...
function initMenuT(){
	...
	var item = null;
	item = new MenuItem("<%=frameroot%>/images/tb-add.gif","确定","queding",1,"ChangeWidthTable","checkMoreDis");
	sMenu.addItem(item);
	item = new MenuItem("<%=frameroot%>/images/tb-change.gif","取消","quxiao",1,"ChangeWidthTable","checkMoreDis");
	sMenu.addItem(item);

	...
	function createTable(str){
		...
		if(str=='add')
  		...
  		for(var j=1;j<=num;j++){
			...
			c1.align="right";
			c1.innerHTML="<span class='wz'>会议决议"+i+":</span>";		
		...
		<DIV id=contentborder align=center>
			...
			<table width="100%" height="10%" border="0" cellpadding="0"
				...
				<tr>
					...
					<td class="td1" align="left">
					<strong:newdate name="startDate" id="startDate"  width="174.5"
                      skin="whyGreen" isicon="true" dateobj="${startDate}" dateform="yyyy-MM-dd HH:ss"></strong:newdate>
					</td>
					<td width="15%" height="21" class="biao_bg1" align="right">
				...
				<tr>
					...
					<td class="td1" colspan="3" align="left">
						<textarea rows="3" cols="67" id="content" name="content"
							style="overflow:auto"></textarea>
					</td>
				</tr>
				<tr>
					<td height="21" class="biao_bg1" align="right">
						<span class="wz">请假人员：</span>
					</td>
					<td class="td1" colspan="3" align="left">
						<textarea rows="3" cols="67" id="description" name="description"
							style="overflow:auto"></textarea>
					</td>
				</tr>
				<tr>
					<td height="21" class="biao_bg1" align="right">
						<span class="wz">迟到人员：</span>
					</td>
					<td class="td1" colspan="3" align="left">
						<textarea rows="3" cols="67" id="description" name="description"
							style="overflow:auto"></textarea>
				...
				<tr>
					<td height="21" class="biao_bg1" align="right">
						<span class="wz">记要内容：</span>
					</td>
					<td class="td1" colspan="3" align="left">
						<textarea rows="8" cols="67" id="content" name="content"
							style="overflow:auto"></textarea>
					</td>
				</tr>
							...
							<tr>
								...
								<td width="40%">
									<input name="Submit" type="submit" class="input_bg"
										value="添加决议" onclick="createTable('add')">
								</td>
								<td width="25%">

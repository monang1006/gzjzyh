...
function initMenuT(){
	...
	var item = null;
	item = new MenuItem("<%=frameroot%>/images/tianjia.gif","添加议题","addTitle",1,"ChangeWidthTable","checkMoreDis");
	sMenu.addItem(item);
	item = new MenuItem("<%=frameroot%>/images/bianji.gif","编辑议题","editTitle",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
	item = new MenuItem("<%=frameroot%>/images/shanchu.gif","删除议题","deleteTitle",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
	item = new MenuItem("<%=frameroot%>/images/chakan.gif","查看议题","viewTitle",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
	item = new MenuItem("<%=frameroot%>/images/shenyue.gif"," 送  审 ","songshen",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
...
function addTitle(){
	location="meeting_addTitle.jsp";
}
function editTitle(){
	location="meeting_editTitle.jsp";
}
function deleteTitle(){
}
function viewTitle(){
	location="meeting_viewTitle.jsp";
}

...
String themePath="";
if(frameroot.equals("/frame/theme_red")){
		themePath = path + "/theme/theme_red";
}else if(frameroot.equals("/frame/theme_red_12")){
     themePath = path + "/theme/theme_red_12";
   }else if(frameroot.equals("/frame/theme_blue")){
     themePath = path + "/theme/theme_blue";
     }else if(frameroot.equals("/frame/theme_blue_12")){
     themePath = path + "/theme/theme_blue_12";
     }else
     themePath = path + "/theme/theme_default";

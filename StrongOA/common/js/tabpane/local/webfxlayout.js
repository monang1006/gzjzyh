...
/* end browser checks */
webfxLayout = {writeTitle:function (s, s2) {
	...
	if (ie && document.body.currentStyle.writingMode != null) {
		document.write("<div id='webfx-about'>Page designed and maintained by " + "<a href='mailto:erik@eae.net'>Erik Arvidsson</a> &amp; " + "<a href='mailto:eae@eae.net'>Emil A Eklund</a>.</div>");
	}
}};

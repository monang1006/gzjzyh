...
FCKConfig.ToolbarSets["FutureDefaultSet"] = [
	['FontName','-','TextColor','BGColor','-','Link','Table','-','Undo','Redo','-','Preview','PasteWord'],
	['FontSize','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','OrderedList','UnorderedList','Outdent','Indent','Templates']
] ;
FCKConfig.ToolbarSets["HelpeditDefaultSet"] = [
	['FontName','-','TextColor','BGColor','-','Link','Table','-','Undo','Redo','-','Preview','PasteWord'],
	['FontSize','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','OrderedList','UnorderedList','Outdent','Indent']
] ;
FCKConfig.ContextMenu = ['Generic','Link','Anchor','Image','Flash','Select','Textarea','Checkbox','Radio','TextField','HiddenField','ImageButton','Button','BulletedList','NumberedList','TableCell','Table','Form'] ;

FCKConfig.FontColors = '000000,993300,333300,003300,003366,000080,333399,333333,800000,FF6600,808000,808080,008080,0000FF,666699,808080,FF0000,FF9900,99CC00,339966,33CCCC,3366FF,800080,999999,FF00FF,FFCC00,FFFF00,00FF00,00FFFF,00CCFF,993366,C0C0C0,FF99CC,FFCC99,FFFF99,CCFFCC,CCFFFF,99CCFF,CC99FF,FFFFFF' ;

FCKConfig.FontNames		= '宋体;仿宋_GB2312;楷体;黑体;隶书;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
FCKConfig.FontSizes		= '1/极小;2/特小;3/小;4/中;5/大;6/特大;7/极大' ;

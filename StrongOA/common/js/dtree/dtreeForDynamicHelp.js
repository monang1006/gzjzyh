...
function dTree(objName) {
	...
	this.icon = {root:imageRootPath + "/images/base.gif", folder:imageRootPath + "/images/folder.gif", folderOpen:imageRootPath + "/images/folderopen.gif", node:imageRootPath + "/images/page.gif", empty:imageRootPath + "/images/empty.gif", line:imageRootPath + "/images/line.gif", join:imageRootPath + "/images/join.gif", joinBottom:imageRootPath + "/images/joinbottom.gif", plus:imageRootPath + "/images/plus.gif", plusBottom:imageRootPath + "/images/plusbottom.gif", minus:imageRootPath + "/images/minus.gif", minusBottom:imageRootPath + "/images/minusbottom.gif", nlPlus:imageRootPath + "/images/nolines_plus.gif", nlMinus:imageRootPath + "/images/nolines_minus.gif"};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function (node, nodeId) {
	...
	if (node.url) {
		str += "<a id=\"s" + this.obj + nodeId + "\" class=\"" + ((this.config.useSelection) ? ((node._is ? "selectedTextAnchor" : "unselectedTextAnchor")) : "unselectedTextAnchor") + "\" href=javascript:treeHrefTo(\"" + node.url + "\");";
		if (node.title) {

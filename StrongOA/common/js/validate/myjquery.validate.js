...
(function ($) {
	...
	}, messages:{required:" \u8f93\u5165\u4e0d\u80fd\u4e3a\u7a7a.", remote:"Please fix this field.", email:" \u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u90ae\u4ef6\u5730\u5740.", url:"\u8bf7\u8f93\u5165\u5408\u6cd5\u7684URL.", date:" \u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u65e5\u671f.", dateISO:"Please enter a valid date (ISO).", dateDE:"Bitte geben Sie ein g\xfcltiges Datum ein.", number:"\u8bf7\u8f93\u5165\u4e00\u4e2a\u6709\u6548\u6570\u5b57.", numberDE:"Bitte geben Sie eine Nummer ein.", digits:" \u53ea\u80fd\u8f93\u5165\u6574\u6570.", creditcard:" \u8bf7\u8f93\u5165\u5408\u6cd5\u7684\u4fe1\u7528\u5361\u53f7.", equalTo:" \u4e24\u6b21\u8f93\u5165\u4e0d\u4e00\u81f4.", ip:"\u8bf7\u8f93\u5165\u5408\u6cd5\u7684IP\u5730\u5740.", accept:"Please enter a value with a valid extension.", maxlength:$.format(" \u8f93\u5165\u4e0d\u80fd\u8d85\u8fc7 {0} \u4e2a\u5b57\u7b26."), minlength:$.format("\u8bf7\u81f3\u5c11\u8f93\u5165 {0} \u4e2a\u5b57\u7b26."), rangelength:$.format(" \u53ea\u80fd\u8f93\u5165 {0} \u81f3 {1} \u4e2a\u5b57\u7b26."), range:$.format(" \u8f93\u5165\u7684\u503c\u53ea\u80fd\u5728 {0} \u81f3 {1}."), max:$.format(" \u8bf7\u8f93\u5165\u4e00\u4e2a\u5c0f\u4e8e\u6216\u7b49\u4e8e{0}\u7684\u503c."), min:$.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u5927\u4e8e {0} \u7684\u503c."), normal:"\u4e0d\u5f97\u542b\u4e2d\u6587\u6216\u5168\u89d2\u7b26\u53f7"}, autoCreateRanges:false, prototype:{init:function () {
	...
	}}, classRuleSettings:{required:{required:true}, email:{email:true}, url:{url:true}, date:{date:true}, dateISO:{dateISO:true}, dateDE:{dateDE:true}, number:{number:true}, numberDE:{numberDE:true}, digits:{digits:true}, creditcard:{creditcard:true}, normal:{normal:true}, ip:{ip:true}}, addClassRules:function (className, rules) {
	...
	}, normal:function (value, element) {
		return this.optional(element) || /^[_A-Za-z0-9]+$/i.test(element.value);
	}, ip:function (value, element) {
		return this.optional(element) || /^(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$/.test(element.value);

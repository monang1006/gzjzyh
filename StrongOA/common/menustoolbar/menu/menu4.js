...
Menu.prototype.getMeasureDocument = function () {
	...
	if ( mf == null ) {
        ...
        if(posLib.ie8||posLib.ie9){//兼容设置ie8||ie9
	        mfs.width = "150px";
	        mfs.height = "10px";
	    }else{
            mfs.width = "10px";
...
MenuItem.prototype.positionSubMenu = function () {
	...
	var rect = {
		left:	posLib.getElementViewLeft( el ),
    ...
    if((posLib.ie8||posLib.ie9)&&sm.parentMenu.parentMenu){
        left += sm.parentMenu.parentMenu.getLeft();
        width = 125;
    }
...
MenuBar.prototype.toHtml = function () {
	...
	return " <TD id=div_1 noWrap><DIV class=divicon id=dividfavorite><div class=\"menu-bar\" id=\"" + this.id + "\">" +
		itemsHtml.join( "" ) +
		"</div></div></td>";
};

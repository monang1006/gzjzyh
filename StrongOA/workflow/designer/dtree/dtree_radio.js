...
function dTree(objName) {
	...
	this.icon = {
		node				: systemroot + '/dtree/img/flow.gif',
		root				: systemroot + '/dtree/img/base.gif',
		//folder				: systemroot+'/dtree/img/folder.gif',

		folderOpen			: systemroot+'/dtree/img/folderopen.gif',
		
		//root				: systemroot + '/dtree/img/flow.gif',
		folder			: systemroot + '/dtree/img/folder_closed.gif',
...
dTree.prototype.add = function(id, pid, name, url, menu, title, target, icon, iconOpen, open) {
	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, menu, title, target, icon, iconOpen, open);
									  //new Node(id, pid, name, url, title, target, icon,box, iconOpen, open);
};

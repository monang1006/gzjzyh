														...
														<td width="100%" align="right">
															<table width="100%" border="0" align="right"
																...
																<tr>
																	...
																	<td width="90">
																		<a class="Operation"
																			href="structure-view.jsp">
																			<img src="<%=frameroot%>/images/chakan.gif"
																				width="14" height="14" class="img_s">查看编制</a>
																	</td>
																	<td width="5"></td>
																	<td width="90">
																		<a class="Operation"
																			href="javascript:showaudit();">
																			<img src="<%=frameroot%>/images/goujian.gif"
																				width="14" height="14" class="img_s">审核编制</a>
																	</td>
																	<td width="5"></td>

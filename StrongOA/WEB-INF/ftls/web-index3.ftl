...
<frameset rows="167,*"  name="title" cols="*" framespacing="0" frameborder="no" border="0">
  <frame src="<%=path%>/theme/theme!RefreshToolbar.action?pageModelId=402882f037c9ca570137c9db4e9b0005&limitType=6" name="mainFrame" id="mainFrame"   scrolling="no"  noresize="noresize" title="mainFrame" />
  
  <frame src="<%=path%>/fileNameRedirectAction.action?toPage=theme/web-content3.jsp" scrolling="no" name="bottomFrame"  noresize="noresize" id="bottomFrame" title="bottomFrame" />
</frameset>
<noframes>
<body>
</body>

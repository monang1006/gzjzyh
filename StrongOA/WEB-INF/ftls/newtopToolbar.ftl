...
function openLink(url,title,id){
      ...
      // top.perspective_content.document.mainIframe.addTab(id, name, url);
	// top.perspective_content.actions_container.personal_properties_toolbar.navigate(url,title);
	//top.perspective_content.actions_container.personal_properties_toolbar.location=url;
...
function portal(portalId,title){
	...
	//top.perspective_content.actions_container.personal_properties_toolbar.location=<%=basePath%>/desktop/desktopWhole.action?defaultType=2&portalId="+portalId;
							...
							<%
							 ...
							 <%
							  ...
							  %>
										...
										--%>
										<td width="28" align="center" class="help" style="cursor: pointer;">
											<img src="<%=frameroot%>/images/perspective_toolbar/about.gif" width="14" height="14" onclick="showCompanyDetail()" />
										</td>
										<td width="70" class="help" onclick="changePassword()" style="cursor: pointer;">
											修改密码
										</td>
										<td width="28" align="center" class="help" style="cursor: pointer;">
											<img src="<%=frameroot%>/images/perspective_toolbar/exit.gif" width="14" height="14" onclick="gotologin()" />
										</td>
										<td width="50" class="help" onclick="gotologin()" style="cursor: pointer;">
											退出
										</td>
										<td width="80">
									...
									<tr>
										...
										<s:if test="#request.testList!=null && #request.testList.size()>0">
											<s:iterator id="ls" value="#request.testList" status="ls">
												...
												<td nowrap="nowrap" height="28"> 
													<a href="#" onclick="openLink('<%=root%><s:property value="privilAttribute" />','<s:property value="privilName" />','<s:property value="privilSyscode" />')">
														<s:if test="systemset!=null&&systemset.fastMenuFontSize!=null&&systemset.fastMenuFontSize!=\"\"">
								...
								<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
									<tr>
										...
										<td style="cursor: hand" width="25%">
											<a href="#" onclick="top.perspective_content.redirect('<%=root%>/desktop/desktopWhole.action?defaultType=2&operate=view&portalId=<s:property value="portalId" />','<s:property value="portalName" />','<s:property value="portalId" />')">
												<s:if test="systemset!=null&&systemset.fastMenuFontSize!=null&&systemset.fastMenuFontSize!=\"\"">
													<span style="font-size:<s:property value="systemset.fastMenuFontSize"/>px"><s:property value="portalName" /></span>
												</s:if>
												<s:else>

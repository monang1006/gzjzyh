		          ...
		          <div class="navga fle">
		            <ul>
		              <security:authorize ifAllGranted="001-00020001">	             
					  	<li><a href="#" onclick="gotonavigates('00020001','发文处理')">发文处理</a></li>
					  </security:authorize>
					  <security:authorize ifAllGranted="001-00020002">	 
					  	<li><a href="#" onclick="gotonavigates('00020002','收文处理')">收文处理</a></li>
					  </security:authorize>
					  <security:authorize ifAllGranted="001-00010001">	 
		              	<li><a href="#" onclick="gotonavigates('00010001','我的流程')">我的流程</a></li>
		              </security:authorize>
		              <security:authorize ifAllGranted="001-00010002">	 
		              	<li><a href="#" onclick="gotonavigates('00010002','日程管理')">日程管理</a></li>
		              </security:authorize>
		              <security:authorize ifAllGranted="001-00010003">	
		              	<li><a href="#" onclick="top.bottomFrame.navigate('<%=path%>/fileNameRedirectAction.action?toPage=message/message.jsp','内部邮件')">内部邮件</a></li>
		              </security:authorize>
		              <security:authorize ifAllGranted="001-00040002">	 
		             	<li><a href="#" onclick="gotonavigates('00040002','信息发布')">信息发布</a></li>
		              </security:authorize>
		              <security:authorize ifAllGranted="001-00010007">	 
		              	<li><a href="#" onclick="gotonavigates('00010007','文件柜')">文件柜</a></li>
		              </security:authorize>
		              <security:authorize ifAllGranted="001-00010010">	 
		              	<li><a href="#" onclick="gotonavigates('00010010','工作日志')">工作日志</a></li>
		              </security:authorize>
		              <security:authorize ifAllGranted="001-00020008">	 
		              	<li><a href="#" onclick="gotonavigates('00020008','会议管理')">会议管理</a></li>
		              </security:authorize>									
		            </ul>
		          </div>  
		           <!--                                       

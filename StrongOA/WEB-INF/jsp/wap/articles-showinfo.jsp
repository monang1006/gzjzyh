...
<div id="container">
  <div class="nav" style="width:540px;">
    <div class="ntopcenter">查看新闻</div>
    <div class="ntopbot clearfix">
       
      <a href="<%=root%>/wap/articles!getColumnArticleList.action?columnId=${columnId}&currentPage=${currentPage}"><img src="<%=root%>/oa/image/login/sytctop2.png" /></a>
  ...
  <div class="con">
    <div class="tyym">
      <table width="100%">
        <tr>
          <th>标题 : ${ca.toaInfopublishArticle.articlesTitle}
          <br/>时间 : ${latestchangtime}&nbsp;&nbsp;&nbsp;&nbsp;<br/>
								共点击${ca.toaInfopublishArticle.articlesHits}次</th>
        </tr>
        <table>
      	<tr>
            	<tr>

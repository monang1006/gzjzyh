...
.ntopbot{ padding:4px 4px 0; color:#aeb9c9; }
	...
	<body>
		<div id="container">
			...
			<div class="ntopcenter">表单信息</div>
				<div class="ntopbot clearfix">
						<div>
								<a href="<%=root%>/wap/work.action?listMode=10&businessTitle=${businessTitle}&userName=${userName}&currentPage=${currentPage}&worktype=${worktype}"><img src="<%=root%>/oa/image/login/sytctop2.png" /></a>
				...
				<div class="xqy clearfix">
					<table width="100%">
						<c:choose>
								...
								<td class="xqytdta">
									<table width="100%">
										<tr>
											<td>
												<c:out value="${message}" />
												<%-- <form action="<%=root%>/wap/work!wapViewForm.action"
													method="post">
													<tr>
														<td>
															<input type="hidden" name="taskId" value="${taskId}" />
															<input type="hidden" name="businessTitle"
																value="${businessTitle}" />
							...
							<c:otherwise>
								<s:if test="transHtmls!=null&&transHtmls!=\"\"">
									
									<td class="xqytdta">
										<table width="100%">
											<form id="form" action="<%=root%>/wap/work!handleTask.action"
												method="post">
												...
												<table style="width: 100%">
													<%-- <tr>
														<td align="left">
															...
															<td>
															<!--<a
																href="<%=root%>/wap/work.action?listMode=10&businessTitle=${businessTitle}&userName=${userName}&currentPage=${currentPage}&worktype=${worktype}">返回</a>--!>
															<!-- <a class="button1"
																href="<%=root%>/work/mobileoa!viewForm.action?taskId=144694">返回1</a>--!>
														</td>
													</tr>--%>
													<tr>
														<td>
													...
													<tr>
														<td>
															<c:if test="${returnFlag!=null&&returnFlag!=''}">
																<input type="submit" value="办理" id="submitForm" />
															</c:if>
														</td>
													</tr>
												</table>

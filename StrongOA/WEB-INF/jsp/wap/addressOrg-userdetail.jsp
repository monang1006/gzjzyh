...
<head> <meta content="text/html; charset=utf-8" http-equiv="Content-Type" /> 
		<title>查看个人信息</title><meta content="m.taobao.com" name="author" />
...
.titlespan{ height:17px; line-height:17px; background-color:#bfd6e6; }
...
<div id="container">
  <div class="nav" style="width:540px;">
    <div class="ntopcenter">个人信息</div>
    <div class="ntopbot clearfix">
       
      <div>
      		<a href="<%=root%>/wap/addressOrg!getOrguserlist.action?orgId=${orgId}"><img src="<%=root%>/oa/image/login/sytctop2.png" /></a>
  ...
  <div class="lby clearfix">
      <table width="100%">
        <tr>
          <td class="titlespan" colspan="2"></td>
        </tr>
      	<tr>
            	<tr>
            		<td>&nbsp;&nbsp;用户名：</td>

...
.ntopbot{ padding:4px 4px 0; color:#aeb9c9; }
	...
	<body>
		...
		<div id="container">
			...
			<div class="ntopcenter">提示信息</div>
				<div class="ntopbot clearfix">
					<div >
					<a href="<%=root%>/wap/message!waprecvlist.action?currentPage=${currentPage}"><img src="<%=root%>/oa/image/login/sytctop2.png" /></a><a href="<%=root%>/wap/login!getMainInfo.action"><img src="<%=root%>/oa/image/login/sytctop1.png" /></a>
						...
						<td class="xqytdta">
							<table width="100%">
								<form action="<%=root%>/wap/message!wapSendMessage.action"
									...
									<tr>
										<td>
											<font color="red">${folderName }</font>
										</td>
										<td>
											<a

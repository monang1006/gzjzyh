		...
		<div id="container">
			...
			<div class="ntopcenter">提示信息</div>
				<div class="ntopbot clearfix">
					<div>
						<c:if test="${disLogo=='reply'}">
							<a
								href="<%=root%>/wap/message!wapnew.action?forward=reply&msgId=${model.msgId}"
								class="button"><img src="<%=root%>/oa/image/login/sytctop2.png" /></a>
						...
						<c:if test="${disLogo=='forward'}">
							<a
								href="<%=root%>/wap/message!wapnew.action?forward=forward&msgId=${model.msgId}"
								class="button"><img src="<%=root%>/oa/image/login/sytctop2.png" /></a>
								<a href="<%=root%>/wap/login!getMainInfo.action"><img src="<%=root%>/oa/image/login/sytctop1.png" /></a>
								<a href="<%=root%>/j_spring_security_logout"><img src="<%=root%>/oa/image/login/sytctop3.png" /></a>
						</c:if>

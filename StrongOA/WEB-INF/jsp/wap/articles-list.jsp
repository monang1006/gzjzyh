...
<title>新闻列表</title> <meta content="m.taobao.com" name="author" /> 
...
a{ color: #333; cursor:pointer; font-size:"14px"}
a:hover{ color:#000; }
...
<div id="container">
  <div class="nav">
  		<div class="ntopcenter">公告列表</div>
    	<div class="ntopbot clearfix">
       
      		<a href="<%=root%>/wap/articles!tree.action?treeType=wap"><img src="<%=root%>/oa/image/login/sytctop2.png" /></a>
      ...
      <table width="100%">
        <tr>
        	<td class="titlespan" colspan="2">
        		<jsp:include flush="true" page="/oa/include/article-splitPage.jsp"></jsp:include>
        	</td>
        </tr>
        <%--<tr>
          <th>编号</th>
          <th width="118px">发布人</th>
          <th width="118px">发布时间</th>
        </tr>--%>
      	${articleHtml}
      </table>
    </div> 

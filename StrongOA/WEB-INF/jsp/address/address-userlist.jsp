...
<BODY class=contentbodymargin  oncontextmenu="return false;"><!-- oncontextmenu="return false;" onload=initMenuT()-->
...
<DIV id=contentborder align=center>
  ...
  <tr>
    <td height="100%">
    <table width="100%" border="0" cellspacing="0" cellpadding="00">
	<s:form id="myTableForm" action="/address/address!userlist.action">
		<input id="groupId" type="hidden" name="groupId" value="${groupId }"/>
		 ...
		 <tr>
          ...
          <td width="50%" align="center"  class="biao_bg1"><s:textfield name="model.name" cssClass="search" title="输入姓名"></s:textfield></td>
		...
		<webflex:flexTextCol caption="姓名" property="name" 
			showValue="name" showsize="50"  width="70%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
		<webflex:flexTextCol caption="Email" property="defaultEmail"
			showValue="defaultEmail" width="30%" showsize="50" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
	  </webflex:flexTable>
	</s:form>
	</table>
      </td>

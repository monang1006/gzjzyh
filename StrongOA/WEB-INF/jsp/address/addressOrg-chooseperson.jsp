		...
		<script type="text/javascript">
			var loadCount = 0;
				...
				function submitForm(){
					...
					var orgusername = parWin.document.getElementById("orgusername");
					var orguserid   = parWin.document.getElementById("orguserid");
					if(undefined == orgusername || undefined == orguserid){
								...
								<tr>
									<td>
										<DIV class="zzjg" id=contentborder style="background-color: white;" cellpadding="0">
											 <iframe id="selectsTree" name="selectsTree" src="<%=path%>/address/addressOrg!choosetree.action?chooseType=bm"
								  ...
								  <td width="3%"></td>
									<td width="40%">
									  <select id="sel_person" multiple="multiple"  style="width:178px;height: 324px;">
								      </select>
								  	</td>
								</tr>
						  </table>

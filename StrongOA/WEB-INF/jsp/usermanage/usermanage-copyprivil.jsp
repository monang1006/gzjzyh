					...
					<td class="table_headtd">
						<table width="100%" border="0" cellspacing="0" cellpadding="00" style="vertical-align: top;">
							<tr>
								...
								<td align="left">
									<strong>请选择复制至</strong>
								</td>
								<td align="right">
									<s:form id="getpostform" action="/usermanage/usermanage!setCopy.action">
									...
									<table border="0" align="right" cellpadding="00" cellspacing="0">
										<tr>
											...
											<td class="Operation_input" onClick="setcopy();">&nbsp;确&nbsp;定&nbsp;</td>
...
<script>
		...
		function setcopy(){
			var copytoid = getAllCheckedValue(mTree);
			var userid = '${userId}' ;
			//var copytoid = getValue();
			if(copytoid == null || copytoid == "" || copytoid=="|"){
				alert("请选择要复制资源的人员。");
				return false;
			}
		...
		function lazyLoadSubTree(aNode, aExpandOrClose, isFilter){
			if(aNode.others == "user"){
				...
				$.getJSON(scriptroot + "/usermanage/usermanage!lazyLoadUserAndChildOrgs.action",{orgSyscode: aNode.id}, function(jsons){

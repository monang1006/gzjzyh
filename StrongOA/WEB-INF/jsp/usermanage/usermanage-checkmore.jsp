		...
		function checkSubmit(){
	    	...
	    	if(selectedNodes && selectedNodes.length > 0){
	    		...
	    		for(var i=0; i<l; i++){
	    			...
	    			names = names + "," + selectedNodes[i].text;
	    		}
	    		ids = ids.substring(1);
	    		names = names.substring(1);
	    	}
	    	window.dialogArguments.setAreaCodeId(ids,names);
			window.dialogArguments.setOrg(ids,names);
			window.close();
					...
					<td class="table_headtd">
						<table width="100%" border="0" cellspacing="0" cellpadding="00" style="vertical-align: top;">
							<tr>
								...
								<td align="left">
									<strong>设置所属机构</strong>
								</td>
								<td align="right">
									<table border="0" align="right" cellpadding="00" cellspacing="0">
										<tr>
					                  		<td width="7"><img src="<%=frameroot%>/images/ch_h_l.gif"/></td>
											<td class="Operation_input" onclick="checkSubmit()">&nbsp;确&nbsp;定&nbsp;</td>

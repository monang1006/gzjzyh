...
<SCRIPT>
  function viewresult(){
    //查看结果
    window.showModalDialog("<%=path%>/vote/vote!viewResult.action?vote.vid=${vote.vid}",window,'help:no;status:no;scroll:yes;dialogWidth:950px; dialogHeight:700px');
  }
...
<table width="100%" border="0" cellspacing="0" cellpadding="00">
							...
							<td align="right">
								<table border="0" align="right" cellpadding="00" cellspacing="0">
					                <tr>
				                      ...
				                      <td><div style="display:none" id="img_loading"><font color=red>&nbsp;&nbsp;处理中...</font><img src="<%=path%>/oa/image/survey/loading.gif"></div></td>
  ...
  <form action="<%=root%>/vote/vote!submitVote.action" onsubmit="return check();" target="votesbumit" method="post" id="myForm"> 

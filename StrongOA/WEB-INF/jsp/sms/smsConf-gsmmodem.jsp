...
<html>
	...
	<body class="contentbodymargin">
		...
		<DIV id=contentborder cellpadding="0" >
			<form  method="post" action="<%=root%>/sms/smsConf!saveConfig.action" theme="simple" name="smsConfForm" id="smsConfForm" target="myIframe">
				...
				cellspacing="1" align="center" class="table1">
								...
								<tr>
									...
									<td class="td1" title="（选择短信猫的类型）">
										<s:select id="smscomtype" name="model.smscomtype" list="#{'':'全部','1':'CDMA短信猫','0':'GMS短信猫'}" listKey="key" listValue="value" style="width:50%"/>
									</td>
								</tr>
								<tr>
									<td width="20%" height="21" class="biao_bg1" align="right">
					...
					<tr align="center">
						<td class="td1">
							<br>
							<input id="smscomId" type="hidden" name="smscomId" value="${model.smscomId}">
							<input type="hidden" name="sendid" value="gsmmodem">

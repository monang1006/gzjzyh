...
<html>
	...
	<tr><td style="width: 100%;height:30px;"><img src="<%=frameroot%>/images/ico/ico.gif" width="9" height="9" alt="">
			&nbsp;&nbsp;&nbsp;&nbsp;<font size="3">处室内部公文办理情况</font></td></tr>
	<tr>
		...
		<fieldset style="width: 100%;height: 100%; overflow: auto; ">
			...
			<script type="text/javascript">
				   ...
				   chart.render("chartdiv");
				    //单击柱状图时，调用该方法
				   function myJS(appointUserId,workflowType,state,processTimeout){
				  	window.location.href="<%=path%>/work/work!todoOfAppointUser.action"
				  							+"?state="+state+"&workflowType="+workflowType
				  							+"&appointUserId="+appointUserId+"&processTimeout="+processTimeout;
				   }
				</script>
		</fieldset>
	</td>

  ...
  <head>
    ...
    <script type="text/javascript">  
    	...
    	function openDoc() {
              ...
              var formId = info[3];
              parent.location = "<%=root%>/work/work!viewEntrust.action?bussinessId="+bussinessId+
  ...
  <script type="text/javascript"
    ...
    <div id="contentborder" align="center">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="vertical-align: top;">
                  	...
                  	<tr>
                  	 <security:authorize ifAnyGranted="001-0002000100040001, 001-0001000100040001">
		                ...
		                <td width="5">
		             	...
		             	<td ><a  class="Operation" href="javascript:workflowView();"><img class="img_s" src="<%=root%>/images/ico/chakan.gif" width="15" height="15" alt="">办理状记录&nbsp;</a></td>
		                <td width="5"> </td>
        ...
        <tr>
          <td height="100%">
          <s:form name="myTableForm" action="/work/work!entrustlist.action">
          <s:hidden id="workflowType" name="workflowType"></s:hidden>
            <webflex:flexTable name="myTable" width="100%" height="200px"
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="1"
                ...
                <tr>
                  ...
                  <td width="10%" class="biao_bg1">
                    <s:textfield name="userName" title="被委派人" cssClass="search"></s:textfield> 
                  </td>
              ...
              <webflex:flexTextCol caption="被委派人" showsize="45" valuepos="11" valueshowpos="11" width="10%" isCanDrag="true"
                isCanSort="true"></webflex:flexTextCol>

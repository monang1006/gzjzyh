  ...
  <body class="contentbodymargin" oncontextmenu="return false;" onload="initMenuT();">
    ...
    <div id="contentborder" align="center">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="vertical-align: top;">
              ...
              <tr>
                ...
                <td width="55%">
                  <table border="0" align="right" cellpadding="00" cellspacing="0">
                  	<tr>
                  		<td ><a  class="Operation" href="JavaScript:pendWork();"><img class="img_s" src="<%=root%>/images/ico/banli.gif" width="15" height="15" alt="">办理&nbsp;</a></td>
		                <td width="5">&nbsp;</td>
		            <td >
					...
					<td width="5"></td>
		                <td ><a  class="Operation" href="JavaScript:zp();"><img class="img_s" src="<%=root%>/images/ico/weituo.gif" width="15" height="15" alt="">指派&nbsp;</a></td>
		                <td width="5">&nbsp;</td>
                  	</tr>
                  </table>
                </td>
        ...
        <tr>
          <td height="100%">
          <s:form name="myTableForm" action="/work/work!todo.action">
          ...
          <s:hidden name="workflowType"></s:hidden>
            <webflex:flexTable name="myTable" width="100%" height="200px"
              ...
              <webflex:flexTextCol caption="标题" showsize="45" valuepos="0" valueshowpos="6" isCanDrag="true"
                width="42%"  onclick="getinfo(this.value)" isCanSort="true"></webflex:flexTextCol>
             			...
             			if(ch == 'f1'){
							...
							switch (workflowType){
								...
								case '12'://档案管理
									break;	
								default:
									parent.location = "<%=root%>/work/work!input.action?taskId="+taskId+"&listMode=1"+"&instanceId="+instanceId+"&businessName="+encodeURI(encodeURI(bussinessTitle));
									break;										
							}

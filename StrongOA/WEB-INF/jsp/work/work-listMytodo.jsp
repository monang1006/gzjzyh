...
<script type="text/javascript" src="<%=path%>/common/script/My97DatePicker/WdatePicker.js"></script>
    <div id="contentborder" align="center">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="vertical-align: top;">
              ...
              <tr>
                <td class="table_headtd_img" >
						...
						<td align="left">
						    ...
						    <s:elseif test='%{state=="1"}'>我的办结文件</s:elseif>
						</td>
						<td align="right">
        ...
        <tr>
          <td height="100%">
          <s:form name="myTableForm" action="/work/work!listMytodo.action?noTotal=1">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table1_search">
               ...
               <s:else>
				...
				<webflex:flexDateCol caption="办结时间"
										...
										width="15%" isCanDrag="false"
										dateFormat="yyyy-MM-dd HH:mm" isCanSort="false"></webflex:flexDateCol>
	              <webflex:flexTextCol caption="发起人" align="center"
...
function tjst(){
	window.location.href="<%=path%>/senddoc/sendDoc!myTodoWorkflow.action?state=${state}&workflowType=${workflowType}&excludeWorkflowType=${excludeWorkflowType}&handleKind=${handleKind}";
}
		...
		function feedBack(){
	      ...
	      function mustFetchTask(){
	    	   var bussinessId = getValue();
				...
				var taskId = bussinessId;
				var instanceId = info[0];
				var isExsitTodo;
				        //通过任务实例id  得到当前任务是否在待办事宜
					 $.ajax( {
							type : "post",
							dataType : "text",
							url : "<%=root%>/senddoc/sendDoc!getisExsitTodo.action",
						               ...
						               isExsitTodo=msg;
						            		if(isExsitTodo == "0"){
											      	if(confirm("您确定要强制取回吗？")){
											    		...
											    		var remindType=""; //提醒方式
												        var url = "<%=path%>/fileNameRedirectAction.action?toPage=senddoc/sendDoc-timerRemind.jsp?instanceId="+instanceId;

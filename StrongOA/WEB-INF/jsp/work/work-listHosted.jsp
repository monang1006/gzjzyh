...
<script type="text/javascript" src="<%=path%>/common/script/My97DatePicker/WdatePicker.js"></script>
    <div id="contentborder" align="center">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="vertical-align: top;">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="table_headtd_img" >
						...
						<td align="left">
						    <s:if test='%{workflowType=="2"}'><strong>已拟公文</strong></s:if>
						    <s:elseif test='%{workflowType=="3"}'> <strong>主办来文</strong></s:elseif>
							<s:else><strong>我的请求</strong></s:else>
						</td>
						<td align="right">
        ...
        <tr>
          <td height="100%">
          <s:form name="myTableForm" action="/work/work!listHosted.action?noTotal=1">
...
function tjst(){
	window.location.href="<%=path%>/senddoc/sendDoc!hostedWorkflow.action?state=${state}&workflowType=${workflowType}&excludeWorkflowType=${excludeWorkflowType}&handleKind=${handleKind}";
}
    </script>
  </body>
</html>

	...
	<head>
		...
		//校验文件夹名称是否已经使用
			function checkFolderNameIsUsed(){
				...
				$.post("<%=root%>/prsnfldr/departmentprsnfldr/departmentPrsnfldrFolder!checkFolderName.action",
...
<div style="height:100%;overflow: auto;">
	<label id="l_actionMessage" style="display: none;"><s:actionmessage/></label>
		<form action="<%=root%>/prsnfldr/departmentprsnfldr/departmentPrsnfldrFolder!save.action" method="post">

...
<div style="height:100%;overflow: auto;">
	<label id="l_actionMessage" style="display: none;"><s:actionmessage/></label>
		<form id="foldForm" action="<%=root%>/prsnfldr/privateprsnfldr/prsnfldrFolder!edit.action" method="post">
			...
			<table  border="0" cellpadding="0" cellspacing="1" class="table1" width="100%" >
				...
				<td  class="td1">
					<input type="text" id="folderName" name="model.folderName" value="${model.folderName }" size="64" class="required" maxlength="64" style="width: 52%;"/>
				</td>
			</tr>
			<tr>
			...
			<%--<tr>
				<td colspan="2"  class="td1" align="center">
        			<input class="input_bg" icoPath="<%=root%>/images/ico/queding.gif" value="保存" />&nbsp;&nbsp;&nbsp;&nbsp;
        			<input id="btnCancel" type="button" icoPath="<%=root%>/images/ico/quxiao.gif" class="input_bg" value="  取消" />
				</td>
			</tr>
			--%></table>
			</td>

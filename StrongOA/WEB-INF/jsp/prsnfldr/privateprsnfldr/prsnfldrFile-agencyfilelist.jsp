...
<DIV id=contentborder align=center>
  ...
  <tr>
          ...
          <tr>
            ...
            <table border="0"  align="right" cellpadding="00" cellspacing="0">
                <tr>
                  ...
                  <security:authorize ifAnyGranted="001-0001000700050006">
                   ...
                   <security:authorize ifAnyGranted="001-0001000700050005">
                  ...
                  <security:authorize ifAnyGranted="001-0001000700050004">
                  ...
                  <security:authorize ifAnyGranted="001-0001000700050009">
                   ...
                   <security:authorize ifAnyGranted="001-0001000700050008">
                  ...
                  <security:authorize ifAnyGranted="001-0001000700050007">
	...
	<s:form id="myTableForm" action="/prsnfldr/privateprsnfldr/prsnfldrFile!agencyFileList.action">
...
function gotoAdd(){
	...
	if(ret!=undefined && ret!="None"){
		parent.project_work_content.document.location="<%=root%>/prsnfldr/privateprsnfldr/prsnfldrFile!agencyFileList.action?folderId="+$("#folderId").val();
	}
}
//搜索
function gotoSearch(){
...
function gotoDel(){
	...
	//添加文件夹
	function addFolder(){
		var ret=OpenWindow("<%=root%>/prsnfldr/agencyprsnfldr/agencyPrsnfldrFolder!init.action","400","150",window);
		if(ret!=undefined && ret!="None"){

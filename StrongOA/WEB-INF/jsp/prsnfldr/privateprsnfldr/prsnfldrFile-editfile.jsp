	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				var privlprop = '${privlprop}';
				if(privlprop == 'readonly'){
					$("#btnOK_newLocalFile").attr("disabled","disabled");
					$("#fileTitle").attr("readonly","true");
				}
			});
		</script>
			<script type="text/javascript">
	...
	<div style="height:100%;overflow: auto;">
		...
		<form id="fileForm" name="fileForm" action="<%=root%>/prsnfldr/privateprsnfldr/prsnfldrFile!editFile.action" method="post">
												...
												<td align="right">
													<table border="0" align="right" cellpadding="00" cellspacing="0">
										                <tr>
										                 	...
										                 	<td class="Operation_input" onclick="$('#btnOK_newLocalFile').click();">&nbsp;确&nbsp;定&nbsp;</td>
			...
			<tr>
				...
				<td width="15%" height="21" class="biao_bg1" align="right"><span class="wz"><font color='red'>*</font> 标题：</span></td>
				<td  class="td1" colspan="3">
					<s:textfield id="fileTitle" cssStyle="width:300px" name="model.fileTitle" maxlength="20"></s:textfield>
				</td>
			</tr>
			<tr>
				<td width="10%" height="21" class="biao_bg1" align="right"><span class="wz">附件：</span></td>
				<td  class="td1" colspan="3">
			...
			<tr>
				<td width="10%" height="21" class="biao_bg1" align="right" valign="top"><span class="wz">备注：</span></td>
			...
			<tr>
				<td width="10%" height="21" class="biao_bg1" align="right"><span class="wz">添加人：</span></td>
				<td  class="td1">
					<s:text name="userName"></s:text>
				</td>
				</tr>
				<tr>
				<td width="15%" height="21" class="biao_bg1" align="right"><span class="wz">添加日期：</span></td>
				<td  class="td1">
			...
			<tr>
				<td colspan="4"  class="td1" align="center">
        			<input id="btnOK_newLocalFile" type="hidden" class="input_bg" icoPath="<%=root%>/images/ico/queding.gif" value="  确定" />&nbsp;&nbsp;&nbsp;&nbsp;
        			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

	...
	<head>
		...
		<script type="text/javascript">
			...
			function checkFolderNameIsUsed(){
				...
				$.post("<%=root%>/prsnfldr/privateprsnfldr/prsnfldrFolder!checkFolderName.action",
...
<div style="height:100%;overflow: auto;">
	<label id="l_actionMessage" style="display: none;"><s:actionmessage/></label>
		<form action="<%=root%>/prsnfldr/privateprsnfldr/prsnfldrFolder!save.action" method="post">
			...
			<tr>
				...
				<td  height="21" class="biao_bg1" align="right"><span class="wz"><font color='red'>*</font> 文件夹名称：</span></td>
				<td  class="td1" style="padding-left:5px;">
					<input type="text" id="folderName" name="model.folderName" size="64" style="width: 95%;"/>
			  <%--<input id="chkShare" type="checkbox" name="isShare">共享
				--%></td>
			...
			<tr>
				<td  height="21" class="biao_bg1" align="right"><span class="wz">文件夹位置：</span></td>
				<td  class="td1">

...
<DIV id=contentborder align=center>
  ...
  <tr>
          ...
          <tr>
            ...
            <table border="0"  align="right" cellpadding="00" cellspacing="0">
                <tr>
                  ...
                  <security:authorize ifAnyGranted="001-0001000700040006">
                   ...
                   <security:authorize ifAnyGranted="001-0001000700040005">
                  ...
                  <security:authorize ifAnyGranted="001-0001000700040004">
                  ...
                  <security:authorize ifAnyGranted="001-0001000700040009">
                   ...
                   <security:authorize ifAnyGranted="001-0001000700040008">
                  ...
                  <security:authorize ifAnyGranted="001-0001000700040007">
	...
	<s:form id="myTableForm" action="/prsnfldr/privateprsnfldr/prsnfldrFile!departmentFileList.action">
        ...
        <tr>
          <td width="4%" align="center"  class="biao_bg1"><img onclick="javascript:gotoSearch();" title="单击搜索" style="cursor: hand;" src="<%=root%>/images/ico/sousuo.gif" width="15" height="15" ></td>
		...
		<webflex:flexTextCol caption="标题" valuepos="0" onclick="javascript:gotoViewByTitle(this.value);" valueshowpos="1"  width="36%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
		...
		<webflex:flexTextCol caption="查阅数" valuepos="4" valueshowpos="4" width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
		<webflex:flexTextCol caption="添加人" valuepos="5" valueshowpos="5" width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
	</webflex:flexTable>
	</s:form>
	</table>
      </td>
...
function gotoAdd(){
	if($("#folderId").val() == null || $("#folderId").val() == ""){
		if(confirm("您还没有创建文件夹，是否创建新文件夹？")){
				addFolder();
				return;
			}
	}
	var ret=OpenWindow("<%=root%>/prsnfldr/privateprsnfldr/prsnfldrFile!init.action?folderId="+$("#folderId").val(),"500","325",window);
	if(ret!=undefined && ret!="None"){
		parent.project_work_content.document.location="<%=root%>/prsnfldr/privateprsnfldr/prsnfldrFile!departmentFileList.action?folderId="+$("#folderId").val();
	}
}
//搜索
function gotoSearch(){
...
function gotoDel(){
	...
	//添加文件夹
	function addFolder(){
		var ret=OpenWindow("<%=root%>/prsnfldr/departmentprsnfldr/departmentPrsnfldrFolder!init.action","400","150",window);
		if(ret!=undefined && ret!="None"){
	...
	$(document).ready(function(){
		var name = "${folderName }";
		//alert(name);
<%--		if(name!=""&&name.indexOf("onclick")>0){--%>
<%--			if(confirm("您还没有创建文件夹，是否创建新文件夹？")){--%>
<%--				addFolder();--%>
<%--			}--%>
<%--		}--%>

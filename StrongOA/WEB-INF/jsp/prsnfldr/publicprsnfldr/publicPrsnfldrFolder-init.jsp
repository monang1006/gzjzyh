	...
	<head>
		...
		//校验文件夹名称是否已经使用
			function checkFolderNameIsUsed(){
				...
				$.post("<%=root%>/prsnfldr/publicprsnfldr/publicPrsnfldrFolder!checkFolderName.action",
...
<div style="height:100%;overflow: auto;">
	<label id="l_actionMessage" style="display: none;"><s:actionmessage/></label>
		<form action="<%=root%>/prsnfldr/publicprsnfldr/publicPrsnfldrFolder!save.action" method="post">
												...
												<td align="right">
													<table border="0" align="right" cellpadding="00" cellspacing="0">
										                <tr>
										                 	...
										                 	<td class="Operation_input" onclick="checkFolderNameIsUsed();">&nbsp;确&nbsp;定&nbsp;</td>
			...
			<%--<tr>
				<td colspan="2"  class="td1" align="center">
        			<input type="button" class="input_bg" onclick="checkFolderNameIsUsed();" value="保存" />&nbsp;&nbsp;&nbsp;&nbsp;
        			<input type="button" onclick="window.close();" class="input_bg" value="取消" />
				</td>
			</tr>
			--%></table>
			</td>

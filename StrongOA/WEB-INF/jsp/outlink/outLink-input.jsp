			...
			function save(){
				if($.trim($("#addrDes").val())==''){
					...
					$.ajax({
						...
						data:"des="+$("#addrDes").val()+"&address="+$("#address").val()+"&type="+$('input[@name=type][@checked]').val(),
					...
					<td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td class="td1">			
									<input type="text" id="addrDes"  name="addrDes" maxlength=50 size="70">
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td1">
									<input type="text" id="address"  name="address" maxlength=200 size="70">
								</td>
							</tr>
							<tr>
								<td  height="21" class="biao_bg1" align="right">
								...
								<td class="td1">
									<s:radio id="type" name="type" list="#{'0':'桌面链接' , '1':'首页链接','2':'处理类链接' }" listKey="key" listValue="value" value="0"/>
								</td>
							</tr>
							<tr>

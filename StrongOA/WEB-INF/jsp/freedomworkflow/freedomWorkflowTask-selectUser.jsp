          ...
          <div align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="00" height="44px;"  class="table_headtd" style="vertical-align: top;">
              ...
              <tr>
                ...
                <td align="left"><strong>请选择用户</strong></td>
                 <td align="right">
            ...
            <div style="height:499px;  overflow-y:auto; overflow-x:hidden; widows:100%">
              <div style="padding:0 20px; text-align: left;" id="user-tree">
            	<span style="text-align:left;color:#999;font-size:12px;line-height:30px;">提示：双击用户名可以直接选中。</span>
                <tree:strongbigtree title="<%=title%>" data="<%=data%>" dealclass="com.strongit.oa.common.tree.TreeImpl" oncheckboxclick="chkclick" check="false"/>
              </div>
            </div>
          </div>
        </DIV>
...
$(function(){
	$("#user-tree").on("dblclick", "a.bbit-tree-node-anchor", function(){
		var items = $("#bigTreeDiv").getTCT();

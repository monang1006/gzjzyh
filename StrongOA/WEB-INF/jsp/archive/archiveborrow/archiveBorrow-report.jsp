	...
	<body class="contentbodymargin">
		<DIV id=contentborder align=center style="OVERFLOW: hidden;">
			<iframe id='SearchContent' style="display:" name='SearchContent'
				src='<%=root%>/fileNameRedirectAction.action?toPage=archive/archiveborrow/poeratepage.jsp'
				frameborder=0 scrolling=auto width='100%' height='14%'></iframe>
			<hr>
			<iframe id='SearchContent1' style="display:" name='SearchContent1'
				src='<%=root%>/fileNameRedirectAction.action?toPage=archive/archiveborrow/reportpage.jsp'

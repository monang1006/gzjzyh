...
<%--								size="32" value="${model.docgroupId}">--%>
							<input id="redtempGroupParentId" name="model.redtempGroupParentId" type="hidden"
								size="32" value="${redtempGroupId}">
							<table width="100%" height="10%" border="0" cellpadding="0"
								cellspacing="1" align="center" class="table1">
								<tr>
									<td width="30%" height="21" class="biao_bg1" align="right">
										<span class="wz">所属套红类别：</span>
									</td>
									<td  class="td1" colspan="3" align="left" title='${docredGroupName}'>
										<s:if test="docredGroupName==null">
											公文套红类别
										</s:if>
										<s:else>
										<script>
										 var docredGroupName = "${docredGroupName}"
										 if (docredGroupName.length<15){
										 	document.write(docredGroupName)
										 }else{
										 	document.write(docredGroupName.substring(0,15)+"...");
										 }
										</script>
										</s:else>
										</td>
								...
								<tr>
									<td width="30%" height="21" class="biao_bg1" align="right">
										<span class="wz">套红类别名称(<FONT color="red">*</FONT>)：</span>
									</td>

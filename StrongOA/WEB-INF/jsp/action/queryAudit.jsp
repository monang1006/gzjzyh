								...
								<td colspan="3" class="table_headtd">
									<table width="100%" border="0" cellspacing="0" cellpadding="00">
										<tr>
											...
											<td align="left"><strong>待审核申请列表</strong></td>
											<td align="right">
												<table border="0" align="right" cellpadding="00"
													...
													<tr>
														...
														<td class="Operation_list" onclick="auditApply();"><img
...
function initMenuT(){
	...
	var item = null;
	item = new MenuItem("<%=root%>/images/operationbtn/edit.png","审核","auditApply",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
...
function auditApply(){
	...
	var result=window.showModalDialog("<%=path%>/action/queryAudit!input.action?appId="+id,

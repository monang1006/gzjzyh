...
<BODY class=contentbodymargin oncontextmenu="return false;"
	...
	<DIV id=contentborder align=center>
		<s:form theme="simple" id="myTableForm"
			action="/action/queryBank!signList.action">
								...
								<td colspan="3" class="table_headtd">
									<table width="100%" border="0" cellspacing="0" cellpadding="00">
										<tr>
											...
											<td align="left"><strong>待处理申请列表</strong></td>
											<td align="right">
												<table border="0" align="right" cellpadding="00"
													...
													<tr>
														...
														<td class="Operation_list" onclick="processApply();"><img
															src="<%=root%>/images/operationbtn/edit.png" />&nbsp;处&nbsp;理&nbsp;</td>
														<td width="4"><img
...
function initMenuT(){
	...
	var item = null;
	item = new MenuItem("<%=root%>/images/operationbtn/edit.png","处理","processApply",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
...
function processApply(){
	...
	var result=window.showModalDialog("<%=path%>/action/queryBank!goProcess.action?appId="+id,

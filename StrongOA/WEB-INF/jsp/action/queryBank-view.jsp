...
function down(){
	var appIds = $("#appId").val();alert(appIds);
	var url = "<%=path%>/action/queryBank!downAttachment.action?appIds="+appIds
	location.href=url;	
}
				...
				<td height="100%">
					...
					<table width="100%" height="10%" border="0" cellpadding="0"
						...
						<tr>
							...
							<a href="javascript:void(0)" target="hiddenFrame" onclick="down()" style="color:red;text-decoration:underline;"  >下载附件</a>
							</td>							
						</tr>						
					</table>

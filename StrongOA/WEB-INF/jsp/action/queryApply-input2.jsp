...
<body style="background-color: #ffffff">
	<DIV id=contentborder align=center>
		<s:form action="/action/queryApply!save.action"
			...
			<div id="audit_d">
				...
				<div style="border-top: solid rgb(0, 0, 0) 1px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="00">
						<tr>
							<td class="biao_bg1" align="right"><span class="wz">&nbsp;审核人：&nbsp;</span></td>
							<td class="td1" align="left"><input id="caseCode"
								value="${model.gzjzyhApplication.appAuditUser}"
								name="model.gzjzyhApplication.appAuditUser" type="text"
								maxlength="25" /></td>

						</tr>
						<tr>
							<td class="biao_bg1" align="right"><span class="wz">&nbsp;审核时间：&nbsp;</span></td>
							<td class="td1" align="left"><strong:newdate
									id="caseConfirmTime"
									name="model.gzjzyhApplication.appAuditDate"
									width="40%" dateform="yyyy-MM-dd HH:mm:ss" isicon="true"
									dateobj="${model.gzjzyhApplication.appAuditDate}"
									classtyle="search" title="搜索结束时间" /></td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="00">
									...
									<tr>
										...
										<td class="td1" align="left" height="200px"><img
											id="imgTable"
											style="width: 120px; height: 120px; border: 1px green solid;" />
											<table>
												<tr>
													<td><label for="d_daiPicDog"> <span
															style="font-size: 20px; color: #4687C2;">照片</span>
									...
									<tr>
										...
										<td class="td1" align="left" height="200px"><img
											...
											<table>
												<tr>
													<td>
														<label>Date of Birth: <input type="file" name="DofB" style="display: none" /></label>
													<td>
												</tr>
											</table></td>
						...
						<td colspan="3" class="table_headtd">
							<table border="0" align="center" cellpadding="00" cellspacing="0">
								<tr>
									...
									<td class="Operation_input" onclick="formsubmit();">&nbsp;确&nbsp;定&nbsp;</td>
...
$(function(){ 
	...
	var appNgReason = $("#appNgReason").val();
	if(appNgReason!=null && appNgReason!=""){
...
function formsubmit(){
	...
	function accountImp(){
		...
		var result=window.showModalDialog("<%=path%>/action/queryApply!imp.action", window,"dialogWidth:" + width + "pt;dialogHeight:" + height + "pt;"

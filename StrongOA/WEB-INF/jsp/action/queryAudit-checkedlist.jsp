...
<BODY class=contentbodymargin oncontextmenu="return false;"
	...
	<DIV id=contentborder align=center>
		<s:form theme="simple" id="myTableForm"
			action="/action/queryAudit!checkedList.action">
								...
								<td colspan="3" class="table_headtd">
									<table width="100%" border="0" cellspacing="0" cellpadding="00">
										<tr>
											...
											<td align="left"><strong>已审批申请列表</strong></td>
											<td align="right">
												<table border="0" align="right" cellpadding="00"
													cellspacing="0">
													<tr>
														<td class="Operation_list" onclick="editApply();"><img
															src="<%=root%>/images/operationbtn/edit.png" />&nbsp;查&nbsp;看&nbsp;</td>
														<td width="4"><img
							...
							<tr>
								<td><webflex:flexTable name="myTable" width="100%"
										...
										<webflex:flexEnumCol caption="申请类型" align="center"
											mapobj="${typeMap}" property="appType" showValue="appType"
											width="12%" isCanDrag="true" isCanSort="true"></webflex:flexEnumCol>
...
function initMenuT(){
	...
	var item = null;
	item = new MenuItem("<%=root%>/images/operationbtn/edit.png","查看","editApply",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
...
function editApply(){
	...
	var result=window.showModalDialog("<%=path%>/action/queryAudit!view.action?appIds="
														+ id,
												window,
												"dialogWidth:"
														+ width

		...
		<DIV id=contentborder align=center>
			...
			<s:form
				...
				<table width="100%" height="10%" border="0" cellpadding="0"
					...
					<tr>
						...
						<td colspan="3" class="td1" align="left">
							<input id="noticeTitle" name="model.noticeTitle" type="text" 
								value="${model.noticeTitle}"  readonly="true"  size="55" maxlength="100">
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3" class="td1" align="left">
							<input id="noticeAddr" name="model.noticeAddr"
								value="${model.noticeAddr}" readonly="true" type="text" size="55">
						</td>
					</tr>
					...
					<tr id="tr_hyyt">
						<td width="15%" height="21" class="biao_bg1" align="center">
							<span class="wz">会议议题：</span>
						</td>
						<td class="td1" colspan="3" align="left">
							<s:textarea cols="60" id="topSubject" name="topSubject" readonly="true"
					...
					<tr>
						...
						<td class="td1" colspan="3" align="left">
							<s:textarea cols="60" id="orgusername" name="userName" rows="4"
					...
					<tr>
						...
						<td class="td1" colspan="3" align="left">
							...
							<input type="file" onkeydown="return false;" name="upload"
								class="multi required" style="width: 60%;" />
							${attachFiles}
						</td>
					</tr>
				</table>

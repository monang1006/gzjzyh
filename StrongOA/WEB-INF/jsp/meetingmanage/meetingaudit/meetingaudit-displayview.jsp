		...
		<DIV id=contentborder align=center>
				...
				<table width="100%"
					...
					<tr>
						<td>&nbsp;</td>
						<td width="20%">
							<img src="<%=frameroot%>/images/ico/ico.gif" width="9" height="9">&nbsp
						查看议题
						</td>
						<td width="*">
							&nbsp;
				...
				<table width="100%" height="10%" border="0" cellpadding="0"
					...
					<tr>
						...
						<td class="td1" colspan="3" align="left">
							<input id="topicCode" name="model.topicCode"  value="${model.topicCode}" readonly="true" type="text" size="55">
						</td>
					</tr>
					<tr>
						<td width="25%" height="21" class="biao_bg1" align="right">
						...
						<td class="td1" colspan="3" align="left">
							<input id="topicSubject" name="model.topicSubject" value="${model.topicSubject}" readonly="true" type="text" size="55">
						</td>
					</tr>
					<tr>
						...
						<td class="td1" colspan="3" align="left">
							<s:select list="sortList" listKey="topicsortId"
											...
											id="topicsort" name="model.topicsort.topicsortId" style="width:14em" disabled="true" />
					...
					<tr>
						...
						<td class="td1" colspan="3" align="left">
							<input id="topicDemo" name="model.topicDemo"
								value="${model.topicDemo}" type="text" size="55" maxlength="50">
						</td>
					</tr>
					...
					<tr>
						...
						<td class="td1" colspan="3" align="left">
						<div id="ArticleContent" style="width:45%"></div>

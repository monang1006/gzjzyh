...
<html>
	...
	function onclickChar(orgId){
		...
		window.location.href = scriptroot + "/docmonitor/docMonitor!processingDeptLocaltion.action?param.grantOrgId="+orgId+"&param.grantCode=2";
	}
	</script>
	<table style="width: 100%;height: 100%;">
	<tr>
	<td style="width: 100%;height:30px;"><img src="<%=frameroot%>/images/ico/ico.gif" width="9" height="9"
                    alt="">&nbsp;&nbsp;&nbsp;<font size="3">公文监控与统计</font></td></tr>
	<tr>

...
<html>
	...
	<body class="contentbodymargin">
		<div id="contentborder" align="center">
			<form id="meTableForm" action="<%=root %>/docdis/docDis!viewInnerflow.action" method="get" >
				...
				<webflex:flexTable name="meTable" width="100%" height="200px" wholeCss="table1" property="docId" isCanDrag="true"
			            ...
			            <webflex:flexTextCol caption="下发人员" property="userName"
			              showValue="javascript:changeFont(getOrnot,userName)" width="40%" isCanDrag="true"

...
<%--         	               document.getElementById("tempfileNo").value= ret;--%>
         	               if(ret!=null&&ret!=""){
         	               formReader.GetFormControl("Edit_SendCode").Value=ret;
				                  //$("#tempfileNo").val(ret);				
							}            
         	}
   		}
...
function returnfirst(){
	...
	<body class="contentbodymargin" oncontextmenu="return false;"
		...
		<DIV id=contentborder align=center>
			<table width="100%" height="10%" border="0" cellspacing="0" cellpadding="00">
				...
				<td width="70%">
					<table border="0" align="right" cellpadding="00"
						...
						<tr>
							...
							<td >
								<a class="Operation" href="javascript:createNumber();"><img
										src="<%=root%>/images/ico/songshen.gif" width="15"
										height="15" class="img_s">获取文号&nbsp;</a>
							</td>

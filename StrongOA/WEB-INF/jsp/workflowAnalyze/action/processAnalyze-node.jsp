			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td height="100%">
										...
										<tr>
											...
											<td width="55%">
												<table width="100%" border="0" align="right" cellpadding="0"
													...
													<tr>
														<td></td>
														<td ><a  class="Operation" href="javascript:addDelegation();"><img class="img_s" src="<%=root%>/images/ico/tianjia.gif" width="15" height="15" alt="">添加&nbsp;</a></td>
														<td >
															<a class="Operation" href="javascript:viewDelegation();"><img class="img_s" src="<%=root%>/images/ico/chakan.gif" width="15" height="15" alt="">查看&nbsp;</a>
														</td>
														<td >
															
															<a class="Operation" href="javascript:cancelDelegation();"><img class="img_s"  src="<%=root%>/images/ico/quxiao.gif" width="12"
																height="12" alt="">取消&nbsp;</a>
														</td>
														<td width="20">
															&nbsp;
						...
						<form id="myTableForm"
							action="<%=root%>/workflowAnalyze/action/processAnalyze!node.action">
							<webflex:flexTable name="myTable" width="100%" height="370px"
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td width="20%" align="center" class="biao_bg1">
											<input name="pdId" type="text" style="width: 100%">
										</td>
										<td class="biao_bg1">
											&nbsp;
										</td>
								...
								<webflex:flexTextCol caption="任务编号" valuepos="0"
									valueshowpos="0" width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="名 称" valuepos="1" valueshowpos="1"
									width="30%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="实例数" valuepos="2" valueshowpos="2"
									width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="总耗时" valuepos="3" valueshowpos="3"
									width="22%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="平均耗时" valuepos="4"
									valueshowpos="4" width="23%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
							</webflex:flexTable>
						</form>
					</td>
				</tr>

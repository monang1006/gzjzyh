			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td height="100%">
											...
											<td width="55%">
												<table width="100%" border="0" align="right" cellpadding="0"
													...
													<tr>
														...
														<td width="7%">
															<a href="javascript:viewProcess();">查看</a>
														</td>
														<td width="5%">
						...
						<form id="myTableForm"
							action="<%=root%>/workflowAnalyze/action/processAnalyze!pd.action">
							<webflex:flexTable name="myTable" width="100%" height="370px"
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td width="20%" align="center" class="biao_bg1">
											<input name="pdName" type="text" style="width: 100%">
										</td>
										<td class="biao_bg1">
											&nbsp;
										</td>
								...
								<webflex:flexTextCol caption="流程编号" valuepos="0"
								...
								<webflex:flexTextCol caption="名 称" valuepos="1" valueshowpos="1"
									width="25%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="版本号" valuepos="2" valueshowpos="2"
									width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="实例数" valuepos="3" valueshowpos="3"
									width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="总耗时" valuepos="4" valueshowpos="4"
									width="20%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="平均耗时" valuepos="5"
...
function initMenuT(){
	...
	sMenu.addItem(item);
	item = new MenuItem("<%=root%>/images/ico/tb-change.gif","查看","viewProcess",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
...
function viewProcess(){
	var id=getValue();
	location = "<%=root%>/workflowAnalyze/action/processAnalyze!node.action?pdId="+id;
}

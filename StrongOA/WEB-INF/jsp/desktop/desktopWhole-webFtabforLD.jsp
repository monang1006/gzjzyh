	...
	<div id="kpc">
	  <div id="cont" class="clearfix">
	    <div class="conlef fle">
	      <div class="conld02">
	        <dl class="conldlist">
	          <dt class="tit"><span class="dtmore"><a style="font-size:12px; font-weight:normal; padding-right:12px;" href="#" onclick="refreshWorkByTitle('<%=path%>/notify/notify.action','办公门户')">更多>></a></span>通知公告</dt>
	    ...
	    <div class="conrig fri">
	      <div class="conrigdb clearfix">
	        <div class="cnrgblef fle">
              <div class="conrigdt">
	          <div style="position:absolute; z-index:9999; top:6px; left:100px; right:12px;"><span style="float:right;"><a style="font-size:12px; color:#FFF; font-weight:normal;" href="#" onclick="refreshWorkByTitle('<%=path%>/work/work!listtodo.action','办公门户')">更多>></a></span><span style="font-size:14px; color:#FFF; "><a style="color:#FFF; font-weight:normal;" herf="#" onclick="refreshWorkByTitle('<%=path%>/work/work!listtodo.action','办公门户')"><strong id="dbcount">0</strong></a> 条</span></div>
	        ...
	        <dl>
	                    ...
	                    <script type="text/javascript">
									...
									function ref_dbsy(){
										$.ajax({ type:"post",
											...
											data:{workflowType:"2,3,10531,16318,21246,47513,51361,79656,84443,85101,85185,90446,90448,100581,108640,142320,158662,160961,273952,979071,1135397,1191715",showDate:"1",showCreator:"1",showNum:"7",subLength:length1,sectionFontSize:"14"},
											success:function(response){
												if(response==""){
												}else{
	          ...
	          <div class="cnrgbl01">
	            <dl class="cnrgblist">
	              <dt class="tit"><span class="dtmore"><a href="#" onclick="refreshWorkByTitle('<%=path%>/work/work!listtodo.action','办公门户')">更多&gt;&gt;</a></span>待阅文件</dt>
		              	...
		              	<div type="1" id="zywjcontent">
		              	   <script type="text/javascript">
										...
										function ref_zywj(){
											$.ajax({ type:"post",
													url:'<%=path%>/senddoc/sendDoc!showTableTodo.action?'+new Date(),
													data:{workflowType:"1533203",showCreator:"1",showDate:"1",showNum:"7",subLength:length2,sectionFontSize:"14"},
													success:function(response){
														if(response==""){
														}else{
              ...
              <div class="cnrgbr02 cnrgbr03">
	            ...
	            <dl>
				  ...
				  <!--   <dd class="cnrgbr3dd clearfix" style=" min-height:270px; height:auto!important; height:270px;overflow:hidden;">	-->
				   <dd class="cnrgbr3dd clearfix" style="height:260px; overflow:hidden;">
	                <ul>
	          ...
	          <div class="cnrgbr02 cnrgbr05">
	            ...
	            <dl>
	              <dt class="tit">办件统计</dt>
		              <dd class="cnrgbr2dd" id="bjtj" style="height:16px; overflow:hidden;">	
		                <ul>

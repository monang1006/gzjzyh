...
<html>
	<head>
		<cache:cache key="${whole.desktopId}" time="300">
		<title>个人桌面</title>
		...
		<script>
			...
			function OpenNewWindow(url){
				window.open (url, '外部链接', 'top=0, left=0, toolbar=yes, menubar=yes, scrollbars=yes, resizable=yes,location=yes, status=yes');
			}
	...
	<body  class=contentbodymargin style="margin-bottom: 0;margin-top: 0;">
					...
					<div id="layoutdisplay1" style="width:100%;padding:5px;color:#333333;display:">
						...
						<table border="0" align="right" cellpadding="00" cellspacing="0">
					                <tr>
					                 	...
					                 	<td class="Operation_input" onclick="changeColWidth();">&nbsp;确&nbsp;定&nbsp;</td>
...
<%
	...
	System.out.println("***********页面刷新时间:"+time+"ms");
%>
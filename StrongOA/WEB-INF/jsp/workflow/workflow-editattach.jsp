...
<html>
	<head>
      ...
      //打开文档
      function openFromURL(bussinessId) {
          var TANGER_OCX_OBJ = document.getElementById("TANGER_OCX_OBJ");
          var readOnly = "<%=request.getParameter("readOnly")%>";    
          TANGER_OCX_OBJ.OpenFromURL("<%=root%>/senddoc/sendDoc!openWordDocFromUrl.action?bussinessId="+bussinessId);  
          if(readOnly == "true"){
      ...
      $(document).ready(function(){
      		openFromURL("<%=request.getParameter("bussinessId")%>");	
	  }); 
	...
	<body class="contentbodymargin" >
		<form id="doctempForm" name="doctempForm"
			action="<%=request.getParameter("contextPath") %>!saveAttach.action" enctype="multipart/form-data"
			method="post">

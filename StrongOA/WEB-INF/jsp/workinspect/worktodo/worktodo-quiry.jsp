...
<script for="window" event="onload">
 state = true;//初始化完毕
 navigate('<%=path%>/workinspect/worktodo/workTodo!gettodo.action','我的办理件查询');
 navigate('<%=path%>/workinspect/worktodo/workTodo!getsend.action','我的发送件查询');
 navigate('<%=path%>/workinspect/worktodo/workTodo!getdeal.action','任务办理情况统计');
 setSelectedIndex(0);
</script>

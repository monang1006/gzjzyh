...
<html>
	<head>
		...
		function dosave(){
				...
				$("#myForm").attr("action","<%=root%>/workinspect/worksend/workSend!saveDraft.action");
		...
		function dosend(){
				...
				$("#save").attr({'disabled':true});
				$("#send").attr({'disabled':true});
				$("#myForm").attr("action","<%=root%>/workinspect/worksend/workSend!save.action");
				document.myForm.submit();
		}
		/**
		 * 选择承办者
	...
	<body style="overflow: auto">
			...
			<s:form id="myForm" name="myForm"
				...
				<table class="gd_fslist" width="900" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
				    ...
				    <td colspan="3">
					    <input id="recvNames" name="recvNames" type="text" class="input_big_too" readonly="readonly" />
		...
		<div class="gd_icon"><div class="gd_search_icon"><input id="save" name="save" type="button" class="gd_icon_cg" value=" " onclick="dosave();"/>

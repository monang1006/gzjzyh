...
<html>
	<head>
     ...
     <script src="<%=path%>/common/js/common/common.js" type="text/javascript"></script>
		...
		function onbeforeunload_handler(){
			if(flag){
				 window.event.returnValue = "您确定要放弃当前编辑!"; //这里可以放置你想做的操作代码       
			}
		} 
	...
	<body >
		...
		<div class="gd_icon"><div class="gd_search_icon"><input id="save" name="save" type="button" class="gd_icon_cg" value=" "/>

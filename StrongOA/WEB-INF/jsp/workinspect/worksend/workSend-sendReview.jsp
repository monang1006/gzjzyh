			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td height="100%">
						...
						<s:form id="myForm"
							action="/workinspect/worksend/workSend!saveSendReview.action" theme="simple">
							<s:hidden id="sendtaskId" name="review.sendtaskId"></s:hidden>
							<s:hidden id="worktaskId" name="review.worktaskId"></s:hidden>
							<s:hidden id="reviewsid" name="review.reviewsid"></s:hidden>
							<table width="100%" height="10%" border="0" cellpadding="0"
								cellspacing="1" align="center" class="table1">
								<tr>
									<td width="20%" height="21" class="biao_bg1" align="right">
										<span class="wz">工作标题：</span>
									</td>
								...
								<tr>
									...
									<td class="td1" colspan="3" align="left">
								<s:radio id="commpleteLevel" name="review.commpleteLevel" list="#{'0':'按时完成' , '1':'超期完成' }" listKey="key" listValue="value" />
									</td>
								</tr>
								<tr>
									<td width="20%" height="21" class="biao_bg1" align="right">
									...
									<td class="td1" colspan="3" align="left">
										<textarea id="reviewsDemo" name="review.reviewsDemo"
											rows="5" cols="68">${review.reviewsDemo}</textarea>
									</td>
								</tr>
							</table>

...
<html>
	...
	<BODY class=contentbodymargin oncontextmenu="return false;" onLoad="initMenuT()">
		...
		<s:form  id="trainingForm" action="/personnel/trainingmanage/training!personOrg.action">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td width="30%" class="biao_bg1">
									 <!--  <s:textfield  id="sorgName" name="sorgName"  cssClass="search" title="请选择组织机构"></s:textfield>  --> &nbsp;
									 <input id="sorgName" name="sorgName" type="text" value="${sorgName}" style="width:70%;">
									    <INPUT type="button" value="选机构" name="mybutton" onclick="choiceOrg();"/>
...
function choiceOrg(){
   var url="<%=path %>/personnel/personorg/personOrg!choiceOrg.action";

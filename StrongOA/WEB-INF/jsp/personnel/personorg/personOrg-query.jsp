...
<script>
		...
		function select(){
			...
			parent.organiseInfo.personinfo.location="<%=root%>/personnel/baseperson/person!getPersonInfoList.action?orgId="+id+"&audittype=query";
			parent.organiseInfo.otherinfo.location="<%=path%>/fileNameRedirectAction.action?toPage=/personnel/baseperson/temp.jsp";
		}

...
<script for="window" event="onload">
	...
	navigate("<%=root%>/personnel/baseperson/person!getHolidayStatistic.action?orgId="+orgId+"&tables="+tables+"&condition="+encodeURI(encodeURI(condition)),"已休假人员列表");
	navigate("<%=root%>/personnel/baseperson/person!getHolidayStatistic.action?forward=norest&orgId="+orgId+"&tables="+tables+"&condition="+encodeURI(encodeURI(condition)),"未休假人员列表");
	setSelectedIndex(0);
	try{
		msg2.StartListen();
	}catch(e){

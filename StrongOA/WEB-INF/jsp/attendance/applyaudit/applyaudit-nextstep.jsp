...
<html>
  ...
  <body class="contentbodymargin" scroll="auto">
		<s:form id="form" name="form" action="/attendance/applyaudit/applyaudit!handleNextStep.action" method="post">
			  <!-- 标示调用消息接口的模块类型 -->
	  ...
	  <!-- 提醒方式标签 -->
	  <strong:remind defaultRemindContent="发文管理转交提醒：${businessName}" code="<%=GlobalBaseData.SMSCODE_WORKFLOW %>"/>

...
<HTML>
	...
	<BODY class="contentbodymargin"  oncontextmenu="return false;" >
		...
		<s:form id="myTableForm" theme="simple"
							action="/attendance/register/record.action">
...
<%--																					src="<%=root%>/images/ico/bianji.gif" width="14"--%>
<%--																					height="14" class="img_s">编辑</a>--%>
<%--																		</td>--%>
																		<td width="5"></td>
																		<td width="100" align="right">
																			<a class="Operation" href="javascript:calAttendence();"><img
																					src="<%=root%>/images/ico/bianji.gif" width="14"
																					height="14" class="img_s">计算考勤</a>
																		</td>
							...
							<tr><td align="center" width="5%"  class="biao_bg1">
										...
										<td align="left" width="95%"  class="biao_bg1">
											&nbsp;&nbsp;
										姓名：
										<input  type="text" name="userName"  style="width:100px;" maxlength="20" value="${userName}"
												 title="请输入姓名"/>
										&nbsp;&nbsp;&nbsp;&nbsp;
										搜索时间段：
										 <strong:newdate id="beginTime"  width="100px;"  name="beginTime"
												dateform="yyyy-MM-dd" isicon="true"  
												dateobj="${beginTime}"  title="开始日期"/>
										
										至
										 <strong:newdate id="endTime" width="100px;"  name="endTime"
												dateform="yyyy-MM-dd" isicon="true"  
												dateobj="${endTime}"  title="结束日期"/>
										</td>

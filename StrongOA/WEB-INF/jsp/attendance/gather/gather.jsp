...
<HTML>
														...
														<table border="0" align="right" cellpadding="00"
															...
															<tr>
																<td width="*">
																	...
																	<td width="85">
																		<a class="Operation" href="javascript:selectCol();"> <img
																				src="<%=root%>/images/ico/queding.gif"
																				width="15" height="15" class="img_s">选择列</a>
																	</td>
																	<td width="5"></td>
																	<td width="90">
																<a class="Operation" href="javascript:gather();"> <img
																		src="<%=root%>/images/ico/chakan.gif" width="15"
																		height="15" class="img_s">汇总考勤</a>
															</td>
																	<td width="5"></td>
																	<td width="70">
																		<a class="Operation" href="javascript:sub();"> <img
									...
									<tr>
										...
										<%--<td width="12%" align="left" class="biao_bg1">
											<input type="text" id="userName" name="model.userName"
												value="${model.userName}" class="search"  title="请输入姓名" />												
										</td>
										<td  width="16%" align="left" class="biao_bg1">
											<strong:newdate id="statisticsStime" name="model.statisticsStime"
												dateform="yyyy-MM-dd" isicon="true" width="100%"
												dateobj="${model.statisticsStime}" classtyle="search"
												title="请选择汇总开始时间" />	
										</td>
										<td  width="16%" align="left" class="biao_bg1">
											<strong:newdate id="statisticsEtime" name="model.statisticsEtime"
												dateform="yyyy-MM-dd" isicon="true" width="100%"
												dateobj="${model.statisticsEtime}" classtyle="search" title="请选择汇总结束时间" />
										</td>
										--%>
										<td align="left" width="95%"  class="biao_bg1">
											&nbsp;&nbsp;
											姓名：
											<input  type="text" id="userName" name="model.userName" style="width:100px;" maxlength="20" value="${model.userName}"
													 title="请输入姓名"/>
											&nbsp;&nbsp;&nbsp;&nbsp;
											汇总时间段：
											 <strong:newdate id="statisticsStime"  width="120px;"  name="model.statisticsStime"
													dateform="yyyy-MM-dd" isicon="true"  
													dateobj="${model.statisticsStime}"  title="汇总开始时间"/>
											
											至
											 <strong:newdate id="statisticsEtime" width="120px;"  
													dateform="yyyy-MM-dd" isicon="true"  name="model.statisticsEtime"
													dateobj="${model.statisticsEtime}"  title="汇总结束时间"/>
											&nbsp;&nbsp;&nbsp;&nbsp;
											审核状态：
											<s:select id="autiState" name="model.autiState"
												list="#{'未审核':'0','审核中':'1','已审核':'2'}" listKey="value"
												listValue="key" cssStyle="width:80px" 
												onchange="submitForm()"></s:select>
										...
										<table id="myTable" style="vertical-align: top;" align="left"
											...
											<thead>
												<tr
													...
													<th class="biao_bg2" align="center">
	...
	<script language="javascript">
		...
		function initMenuT(){
			...
			var item = null;
			item = new MenuItem("<%=root%>/images/ico/bianji.gif","选择列","selectCol",1,"ChangeWidthTable","checkOneDis");
			sMenu.addItem(item);
			item = new MenuItem("<%=root%>/images/ico/tianjia.gif","汇总考勤","gather",1,"ChangeWidthTable","checkMoreDis");
			sMenu.addItem(item);
			item = new MenuItem("<%=root%>/images/ico/bianji.gif","提交","sub",1,"ChangeWidthTable","checkOneDis");
			sMenu.addItem(item);

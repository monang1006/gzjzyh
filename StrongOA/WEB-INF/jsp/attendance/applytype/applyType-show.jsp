					...
					<td height="100%">
							...
							<table width="100%" height="10%" border="0" cellpadding="0" cellspacing="1" align="center" class="table1">
								...
								<tr>
									...
									<input id="typeName" maxlength="25" readonly="readonly" name="model.typeName" type="text"  value="${model.typeName}" >&nbsp;
								...
								<tr>
									...
									<td class="td1" colspan="3" align="left">
										<s:select id="canRewriter" style="width: 110px;" disabled="true"
								...
								<tr>
									...
									<td class="td1" colspan="3" align="left">
									<s:select id="isAbsence" style="width: 110px;" disabled="true"
						    	...
						    	<tr>
									...
									<textarea  id="typeDesc" rows="5" cols="35" readonly="readonly"  name="model.typeDesc" maxlength="200"  >${model.typeDesc}</textarea>

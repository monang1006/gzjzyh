...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function getMyids(chooseTr){
				...
				if(confirm("您是要使用已经预留的文号："+codename+"?")){
					$.ajax({
						type:"post",
						dataType:"text",
						url:"<%=root%>/autocode/autoCode!useReservedCode.action",
						data:"id="+id,
	...
	<body class="contentbodymargin" oncontextmenu="return false;" onload="initMenuT()">
		...
		<form id="myTableForm" action="<%=path%>/autocode/autoCode!getReservedCode.action" method="post">
		<%-- 
								...
								<td width="70%">
									<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
										<tr>
											...
											<td width="135">
												<a class="Operation" href="javascript:useRecCode();"><img src="<%=root%>/images/ico/tianjia.gif" width="15" height="15" class="img_s" />使用预留文号&nbsp;</a>
											</td>
									</table>
								</td>
							</tr>
									...
									style="FILTER:progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#ededed,endColorStr=#ffffff);">
											...
											<table border="0" align="center"  cellpadding="00" cellspacing="0">
								                ...
								                <td width="4"><img src="<%=frameroot%>/images/bt_l.jpg"/></td>
					                 	        <td class="Operation_list" onclick="useRecCode();"><img src="<%=root%>/images/operationbtn/use_Reservation code.png"/>&nbsp;使&nbsp;用&nbsp;预&nbsp;留&nbsp;文&nbsp;号&nbsp;</td>
			  ...
			  <tr>
			  	  <td>
     				<webflex:flexTable name="myTable" width="100%" height="370px" wholeCss="table1" property="logId" ondblclick="getMyids(this)" isCanDrag="true" isCanFixUpCol="true" clickColor="#A9B2CA" footShow="showCheck" getValueType="getValueByProperty" collection="${page.result}" page="${page}">    
						...
						<webflex:flexTextCol caption="创建人员" property="codeUsername" align="center"  showValue="codeUsername" width="20%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
						<webflex:flexTextCol caption="编号状态" property="codeStatus" align="center"  showValue="javascript:viewInfo(codeStatus)" width="20%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
					</webflex:flexTable>
			      </td>
			  </tr>
			</table>

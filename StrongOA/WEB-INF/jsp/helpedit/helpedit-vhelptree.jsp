...
<html>
	<head>
		...
		<script language="javascript">
			...
			mTreeData.addHead(new Array("帮助目录"));
				...
				<tr>
					<td>
						<div id="divMain" style="overflow: auto;"
							onclick="return ( mTree.HTVOnClick());">
						</div>
					</td>
				</tr>
			</table>
...
<c:forEach items="[com.strongit.uums.bo.TUumsBaseSystem@b3b527]"
	var="systemlist">

	<script language="JavaScript">
		mTreeData.addTreeNode('<c:out value="402882101eba1e2f011eba6482540001" />','0',
		                    new Array("<c:out value='协同软件' />"),
		                     '', true,
		                     "", "folder_closed.gif", lStyleArr, "-2",'0');	 	                                                  	                     
	</script>
</c:forEach>

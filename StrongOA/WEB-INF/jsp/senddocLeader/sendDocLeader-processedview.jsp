								...
								<td>
									<table align="right">
										<tr>
											...
											<s:if test="state != 1 && processSuspend==0 && #request.suporgcode==001">
											<td>
												<a class="Operation" href="javascript:sendReminder();">&nbsp;<img
														src="<%=root%>/images/ico/emergency.gif" width="15"
											...
											<td>
												<a class="Operation" href="#"
													onclick="JavaScript:Cur_workflowView('00000');">&nbsp;<img
											...
											<td>
												<a class="Operation" href="#"
													onclick="JavaScript:doPrintForm();">&nbsp;<img
														src="<%=root%>/images/ico/tb-list16.gif" width="15"
														height="15" class="img_s">打印处理单&nbsp;</a>
											</td>

											<td width="5">
											</td>
											<!--<s:if test="(state!=1) && (processSuspend==0) && (flag=='true') && (#request.showrepeal == 1)">
												<td>

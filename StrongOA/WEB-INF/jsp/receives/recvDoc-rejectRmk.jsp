...
<%
	...
	String mytemp = request.getParameter("laiwentitle");
	String laiwentitle = URLDecoder.decode(mytemp,"utf-8");
%>
...
<p class=MsoNormal><span lang=EN-US><o:p>&nbsp;</o:p></span></p>
	...
	<div class=Section1 style='layout-grid:5.6pt'>
			...
			<input type="hidden" id="laiwentitle" name="laiwentitle" vlaue="<%=laiwentitle%>">
			<table align="left">
				<tr>

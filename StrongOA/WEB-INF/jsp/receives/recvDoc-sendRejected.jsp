...
<script type="text/javascript">      
	...
	<body class="contentbodymargin"
		...
		<s:form name="myTableForm" theme="simple"
							action="/receives/recvDoc!sendRejected.action">
                ...
                <tr>
                  ...
                  <td width="11%" align="center" class="biao_bg1">
                    <strong:newdate name="sendStartDate" id="searchDraftDate" width="98%" classtyle="search"
                      skin="whyGreen" isicon="true" dateform="yyyy-MM-dd" title="发文开始时间" dateobj="${sendStartDate}"></strong:newdate>
                  </td>
                  <td width="12%" align="center" class="biao_bg1">
                   <strong:newdate name="sendEndDate" id="searchDraftDate" width="98%" classtyle="search"
                      skin="whyGreen" isicon="true" dateform="yyyy-MM-dd" title="发文结束时间" dateobj="${sendEndDate}"></strong:newdate>
                  </td>
                  <td width="11%" align="center" class="biao_bg1">
                    <strong:newdate name="startDate" id="searchDraftDate" width="98%" classtyle="search"
                      skin="whyGreen" isicon="true" dateform="yyyy-MM-dd" title="拒收开始时间" dateobj="${startDate}"></strong:newdate>
                  </td>
                  <td width="12%" align="center" class="biao_bg1">
                   <strong:newdate name="endDate" id="searchDraftDate" width="98%" classtyle="search"
                      skin="whyGreen" isicon="true" dateform="yyyy-MM-dd" title="拒收结束时间" dateobj="${endDate}"></strong:newdate>
                  </td>
                </tr>
              </table>
	              ...
	              <webflex:flexTextCol caption="公文标题" valuepos="11" valueshowpos="1" isCanDrag="true"
	                width="26%" isCanSort="true" showsize="23" onclick="viewDocClick(this.value)"></webflex:flexTextCol>  
	              <webflex:flexTextCol caption="发文文号" valuepos="0" valueshowpos="0" isCanDrag="true"
	                width="12%" isCanSort="true" showsize="15"></webflex:flexTextCol> 
	              <webflex:flexTextCol caption="拒收单位" valuepos="15" valueshowpos="15" isCanDrag="true"
	                width="14%" isCanSort="true" showsize="10"></webflex:flexTextCol>
	              <webflex:flexDateCol caption="发文时间" valuepos="3" valueshowpos="3"
	                width="11%" isCanDrag="true" dateFormat="yyyy-MM-dd HH:mm" showsize="30" isCanSort="true"></webflex:flexDateCol>

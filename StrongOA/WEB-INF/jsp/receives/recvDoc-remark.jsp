	...
	//关闭窗口
		...
		function save(){ 
			...
			if(groupName.length > 2000)
			 {
			  alert("输入的回执内容长度不能超过2000个字符!");
			  $("#docRecvRemark").focus();
			  return false;
			 }
			document.getElementById("recvState").value = "1";
							...
							<table border="0" cellpadding="0" cellspacing="1" class="table1"
								...
								<tr>
									...
									<td class="td1" width="100%" colspan="2" > 
										<s:textarea title="请输入回执内容" cols="45" id="docRecvRemark" 
										name="docRecvRemark" rows="14" readonly="false" value="已签收！"

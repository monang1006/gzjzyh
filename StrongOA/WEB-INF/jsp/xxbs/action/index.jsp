  ...
  <table width="100%" style="min-width: 1200px">
  	<tr>
        ...
        <dl class="dlefd01">
          ...
          <a href="javascript:redirect('<%=root%>/xxbs/action/bulletin.action','通知公告','00130007');">更多&gt;&gt;</a>
          </span>
           <a href="javascript:redirect('<%=root%>/xxbs/action/bulletin.action','通知公告','00130007');">通知公告</a>
          </dt>
          <dd id="bulletin">
          </dd>
        </dl>
        <dl class="dlefd01 dlefd02">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/invitation.action','约稿管理','00130001');">更多&gt;&gt;</a>
          </span>
           <a href="javascript:redirect('<%=root%>/xxbs/action/invitation.action','约稿管理','00130001');">约稿信息</a>
          </dt>
       ...
       <!--   <dl class="dlefd01 dlefd02">
         ...
         <dl class="dlefd01 dlefd02">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/infoReport.action','通报管理','00130010');">更多&gt;&gt;</a></span>
          <a href="javascript:redirect('<%=root%>/xxbs/action/infoReport.action','通报管理','00130010');">采用通报</a></dt>
      ...
      <td class="dcen">
        <dl class="dcenlis dcenli01">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/handling!content.action','信息处理','00130002');">更多&gt;&gt;</a>
          </span>
          <a href="javascript:redirect('<%=root%>/xxbs/action/handling!content.action','信息处理','00130002');">报送信息</a>
          </dt>
        ...
        <dl class="dcenlis dcenli02">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/handling!content.action?useStatus=1','信息处理','00130002');">更多&gt;&gt;</a>
          </span>
          <a href="javascript:redirect('<%=root%>/xxbs/action/handling!content.action?useStatus=1','信息处理','00130002');">采用信息</a>
          </dt>
        ...
        <dl class="dcenlis dcenli03">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/handling!content.action?useStatus=4','信息处理','00130002');">更多&gt;&gt;</a>
          </span>
          <a href="javascript:redirect('<%=root%>/xxbs/action/handling!content.action?useStatus=4','信息处理','00130002');">共享信息</a>
          </dt>
      ...
      <td class="drig">
        <dl class="driglis drigli01">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/release.action','每日要情','00130003');">更多&gt;&gt;</a>
          </span>
          <a href="javascript:redirect('<%=root%>/xxbs/action/release.action','每日要情','00130003');">每日要情</a>
          </dt>
        ...
        <dl class="driglis drigli01">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/release.action','南昌政务','00130004');">更多&gt;&gt;</a>
          </span>
          <a href="javascript:redirect('<%=root%>/xxbs/action/release.action','南昌政务','00130004');">南昌政务</a>
          </dt>
          <dd style="overflow:hidden; height:210px;" id="issueByZW">
          </dd>
        </dl>
        
        <dl class="driglis drigli02">
          <dt class="tit"><span class="dtmore">
           <a href="javascript:redirect('<%=root%>/xxbs/action/statistics!point.action','采用统计','00130004');">更多&gt;&gt;</a></span>
           <a href="javascript:redirect('<%=root%>/xxbs/action/statistics!point.action','采用统计','00130004');">采用排名</a></dt>
         <dd id="rank1" style="height:200px; font-size:14px;">
          </dd>
        </dl>
        <!--  <dl class="driglis drigli02">
          <dt class="tit"><span class="dtmore">
          <a href="javascript:redirect('<%=root%>/xxbs/action/statistics!findOrg.action','采用统计','00130004');">更多&gt;&gt;</a></span>
           <a href="javascript:redirect('<%=root%>/xxbs/action/statistics!findOrg.action','采用统计','00130004');">南昌政务</a></dt>
...
function journal(id){
	var url = "<%=root%>/xxbs/action/release!content.action?selView=1&toId="+id+"&flag=0&open=1";
...
function getBulletin(){
	var time = new Date();
	$.get("<%=root%>/xxbs/action/index!bulletin.action?time="+time.getTime(), function(data){
		$("#bulletin").html(data);
	}, 'html');
}
...
function findOrg(){
	var isOrg = $("#isOrg").val();
	$.ajax({
		url: "<%=root%>/xxbs/action/index!rank1.action?orgType="+isOrg,
...
$(function(){
	...
	$.ajax({
		url: "<%=root%>/xxbs/action/index!bulletin.action",
		success: function(data){
			$("#bulletin").html(data);
		},
		cache: false,
	...
	$.ajax({
		url: "<%=root%>/xxbs/action/index!rank1.action",
		success: function(data){
			$("#rank1").html(data);
		},
		cache: false,
	...
	$.ajax({
		url: "<%=root%>/xxbs/action/index!issueByZW.action",
		success: function(data){
			$("#issueByZW").html(data);
		},
		cache: false,

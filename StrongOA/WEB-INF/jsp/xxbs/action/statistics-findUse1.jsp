...
.noprint{display : none }
  ...
  <tr>
    <th style="background-color:#e4e9ee; text-align: right; width: 250px ; height: 51px; line-height:1;" colspan="2" ><img src="<%=themePath%>/images/title1.jpg" /></th>
    <th width="50">1月</th>
    <th  width="50">2月</th>
    <th  width="50">3月</th>
    <th  width="50">4月</th>
...
<script>
  document.getElementById(orgid).rowSpan = n;
	 ...
	 */
	function excel(){
		location = "${root}/xxbs/action/statistics!excelSubmit1.action?flag=Use";
	}
	/**
	 * 根据上报信息统计
	 */

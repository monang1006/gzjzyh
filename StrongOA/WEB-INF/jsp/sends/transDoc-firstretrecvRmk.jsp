...
<script type="text/javascript">	
		...
		function save(){ 
			...
			if(groupName.length > 100)
			{
			 ...
			 var url = "<%=path%>/receives/recvDoc!firstsaveretRmk.action";
...
<s:form action="/receives/recvDoc!firstsaveretRmk.action" id="myTable" enctype="multipart/form-data" theme="simple">
<input type="hidden" id="pkFieldValue" name="pkFieldValue" value=""/>

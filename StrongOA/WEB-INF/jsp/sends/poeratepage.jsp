...
<HTML>
	<HEAD>
		...
		function print(){
				...
				var orgId="${param.orgId}";
					...
					url="<%=root%>/sends/docSend!getBorrowReport.action?exportType=print&reportType="+reportType+"&reportDate="+reportDate+"&reportEndDate="+reportEndDate;
	...
	<body class="contentbodymargin" style="overflow:hidden;BACKGROUND:#ffffff">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td height="100%">
						<s:form id="myTableForm" action="/sends/docSend!getBorrowReport.action">
							...
							<table width="100%" height="40">
								<tr>
								    ...
								    <strong:newdate id="reportDate"  width="100px;"  name="reportDate"
											skin="whyGreen"	dateform="yyyy-MM-dd" isicon="true"  title="统计日期"/> --
			...
			<iframe id='SearchContent1' style="display:" name='SearchContent1'
				src='<%=root%>/fileNameRedirectAction.action?toPage=sends/reportpage.jsp'

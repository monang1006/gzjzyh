...
<script type="text/javascript">	
		...
		$(document).ready(function(){
			...
			if(params != null){
				if(params.length > 1){
					var laiwenDW    = params[0];
					var laiwentitle = params[1];
					$("#laiwenDW").text(laiwenDW);
					$("#laiwentitle").text(laiwentitle);
					$("#taskId").val(params[2]);
				}
			}
			var liyou = $("#liyous").val();
			var myliyou = new Array();
			myliyou = liyou.split(",");
			for(var i=0;i<myliyou.length;i++){
				var r=document.getElementsByName("liyou");
    			for(var j=0;j<r.length;j++){
        			if(r[j].value == myliyou[i]){
         				r[j].checked = "checked";
      				}
   	 			}
			}
		...
		function save(){ 
			...
			if(groupName.length > 100)
			{
			 ...
			 var url = "<%=path%>/receives/recvDoc!saveretRmk.action";
			 var d = $("#myTable").serialize();
			 $.post(url,d,function(data){
			 	if(data=="true"){
			 		//var returnValue = "{suggestion:'"+groupName+"',remindType:''}";
...
<s:form action="/receives/recvDoc!saveretRmk.action" id="myTable" enctype="multipart/form-data" theme="simple">
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:12;mso-yfti-lastrow:yes;height:35.4pt'>
  ...
  <p class=MsoNormal><span lang=EN-US><o:p>&nbsp;&nbsp;&nbsp;&nbsp;<s:textarea id="qita" name="modelDocRet.qita" style="width:380px;height:45px;font-size: 16px;"></s:textarea></o:p></span></p>
  </td>
  <td width=24 valign=top style='width:18.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<p class=MsoNormal><span lang=EN-US><o:p>&nbsp;</o:p></span></p>
	...
	<div class=Section1 style='layout-grid:5.6pt'>
		...
		<input type="hidden" id="liyous" name="modelDocRet.liyou" value="${modelDocRet.liyou }" >
		<input type="hidden" id="senddocretId" name="modelDocRet.senddocretId" value="${modelDocRet.senddocretId }" >
		<input type="hidden" id="businessId" name="modelDocRet.businessId" value="${modelDocRet.businessId }" >

			<table align="left">
				<tr>
					<td colspan="3" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<s:label id="laiwenDW" name="laiwenDW" value="你好"></s:label>:
					</td>
				</tr>
				<tr>
					<td align="left" colspan="3">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<s:label id="lab3" name="lab3" value="你单位来文"></s:label>(<s:label id="laiwentitle" name="laiwentitle"></s:label>)
					</td>
					
				</tr>
				<tr>
					<td align="left" width="75%" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<s:textarea id="docRecvRemark" name="modelDocRet.docrecvRemark" style="width:500px;height:20px;font-size: 16px;"

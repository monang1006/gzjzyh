...
<script type="text/javascript">	
		...
		function save(){ 
			...
			if(groupName.length > 100)
			{
			 ...
			 var url = "<%=path%>/receives/recvDoc!saveret.action";
...
<s:form action="/receives/recvDoc!saveret.action" id="myTable" enctype="multipart/form-data" theme="simple">

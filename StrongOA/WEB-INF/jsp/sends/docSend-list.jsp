				...
				<tr>
					<td height="100%">
						<s:form theme="simple" id="myTableForm"
							action="/sends/docSend!sendList.action">
...
<%--																	</security:authorize>--%>
							...
							<webflex:flexTable name="myTable" width="100%" height="370px"
								...
								getValueType="getValueByProperty" collection="${page1.result}"
								page="${page1}" pagename="page1">
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									class="table1">
									<tr>
										<td width="4%"  class="biao_bg1">
											<img src="<%=frameroot%>/images/sousuo.gif" width="17" height="16" onclick="search();" style="cursor: hand;">
										</td>
										
										<td width="28%"  class="biao_bg1">
											 <s:textfield  name="myModel.docTitle"  cssClass="search" title="公文标题"  > </s:textfield>
										</td>
										<td width="18%"  class="biao_bg1">
											 <s:textfield  name="myModel.docCode"  cssClass="search" title="发文文号" ></s:textfield>
										</td>
										<td width="10%"  class="biao_bg1">
											<s:select onchange="search()" cssStyle="width:100%" list="jjcdItems" headerKey="" headerValue="全部" listKey="dictItemName" listValue="dictItemName" name="myModel.docEmergency"></s:select>
										</td>
										<td width="19%"  class="biao_bg1">
											 <s:textfield  name="myModel.docIssueDepartSigned"  cssClass="search" title="发文单位" ></s:textfield>
										</td>
								...
								<webflex:flexDateCol caption="发文时间" property="docSendTime" showValue="docSendTime" width="18%" isCanDrag="true" isCanSort="true" dateFormat="yyyy-MM-dd hh:mm"></webflex:flexDateCol>
	    ...
	    if(data=="1"){
	      ...
	      return;
	    	...
	    	var width=screen.availWidth-10;
   			...
   			url = "<%=path%>/fileNameRedirectAction.action?toPage=sends/docSend-viewPage.jsp?archiveId="+value;

					...
					<td height="100%">
						...
						<s:form id="myTableForm" action="/workflowDesign/action/processMonitor!monitorList.action" method="get">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1" style="display:none"
									class="table1">
									<tr id="search_tr">
										<td width="3%" align="center" class="biao_bg1"><img id='img_sousuo' src="<%=root%>/images/ico/sousuo.gif" width="17" height="16" alt=""></td>
								...
								<webflex:flexTextCol caption="标题" valuepos="0"
									valueshowpos="0" width="35%" isCanDrag="true" isCanSort="true" showsize="30"></webflex:flexTextCol>
								<webflex:flexTextCol caption="主办人员" width="17%" valuepos="1" valueshowpos="1" align="center"
									isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="当前处理人" width="12%" valuepos="8" valueshowpos="8" align="center"
									isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="前一步处理人" width="13%" valuepos="10" valueshowpos="10" align="center"
									isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="状态" valuepos="4" valueshowpos="4"
								 	width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="流程名称" valuepos="6" valueshowpos="6" align="center"
								 	width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								...
								<webflex:flexCheckBoxCol caption="选择" valuepos="2"
									...
									isCanSort="false"></webflex:flexCheckBoxCol>
								<webflex:flexTextCol caption="标题" valuepos="0"
									valueshowpos="0" width="60%" isCanDrag="true" isCanSort="true" showsize="30"></webflex:flexTextCol>
								<webflex:flexTextCol caption="主办人员" width="22%" valuepos="1" valueshowpos="1" align="center"
									isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
								<webflex:flexTextCol caption="流程名称" valuepos="6" valueshowpos="6" align="center"

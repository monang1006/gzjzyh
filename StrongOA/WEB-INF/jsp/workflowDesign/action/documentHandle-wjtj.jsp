...
<html>
	...
	<tr>
		<td style="	height: 30px;background:url(<%=path %>/frame/theme_red/images/ck_line.jpg) repeat-x top;">
								<table width="100%" border="0" cellspacing="0"
												cellpadding="00">
												<tr>
													<td style="	padding-left : 29px;width: 24px;padding-top:3px;" >
									        <img src="<%=frameroot%>/images/ico/ico.gif" >&nbsp;
								                 </td>
													<td align="left" style="font-family:  Verdana, Arial, Helvetica;font-size: 14px;">
														<strong>公文监控与统计</strong>
													</td>
								               <td align="right">
													</td>
												</tr>

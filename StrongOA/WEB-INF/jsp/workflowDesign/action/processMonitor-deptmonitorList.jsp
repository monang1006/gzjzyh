							 ...
							 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table1_search">
									<tr>
										...
										&nbsp;&nbsp;办结年份：&nbsp;
							       		...
							       		<div style=" width:275px;display:inline;">&nbsp;&nbsp;流程名称：&nbsp;<input name="processDefinitionNamesText" id="processDefinitionNamesText" style="width: 90px;"  type="text" class="search" title="请您输入流程名称" value="${processWorkflowNames}">
								...
								<webflex:flexTextCol caption="主办人员" width="10%" property="startUserName" align="center"
									showValue="startUserName" align="center"
									isCanDrag="true" isCanSort="true" showsize="5"></webflex:flexTextCol>
								<webflex:flexTextCol caption="当前处理人" width="10%" property="actorName" align="center"
								showValue="actorName"
								isCanDrag="true" isCanSort="true" showsize="5"></webflex:flexTextCol>
								<webflex:flexTextCol caption="流程名称" property="workflowName" align="center"
									showValue="workflowName" align="center"
								 	width="10%" isCanDrag="true" isCanSort="true" showsize="5"></webflex:flexTextCol>
								...
								<webflex:flexCheckBoxCol caption="选择" property="instanceId"
									...
									isCanSort="false"></webflex:flexCheckBoxCol>
								<webflex:flexTextCol caption="标题" property="instanceId"
									showValue="businessName" width="65%" isCanDrag="true" isCanSort="true" showsize="38"
									 onclick="ViewFormAndWorkflow(this.value);"></webflex:flexTextCol>

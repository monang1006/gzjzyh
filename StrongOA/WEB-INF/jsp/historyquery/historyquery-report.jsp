	...
	<body class="contentbodymargin">
		<DIV id=contentborder align=center style="OVERFLOW: hidden;">
			<iframe id='SearchContent' style="display:" name='SearchContent'
				src='<%=root%>/fileNameRedirectAction.action?toPage=historyquery/poeratepagesend.jsp'
				frameborder=0 scrolling=no width='100%' height='85px'></iframe>
			<hr>
			<iframe id='SearchContent1' style="display:" name='SearchContent1'
				src='<%=root%>/fileNameRedirectAction.action?toPage=historyquery/reportpagesend.jsp'

...
<script language="JavaScript">
	myObject = new Object();
	var code = findFatherCode('<c:out value="${orgList.orgSyscode}" />','<c:out value="${codeType}" />','<c:out value="${syscode}"/>');
	...
	<script>
		...
		function select(){
			...
			var id = sNode.others;
		//	alert(id);
			parent.userlist.location="<%=root%>/orgdeptcode/orgdeptcode.action?extOrgId="+id;
		}

...
function addTab(sTitle,sIcon,sUrl){
	...
	if(oCel.cellIndex==0){
		oCel.innerHTML ="<table width='100%' height='22' border='0' cellpadding='00' cellspacing='0'>"+
							...
							"<td align='center' class='bt1_bg2' noWrap valign='center'>"+
							"<IMG src='"+sIcon+"' id='img_switch'/>"+
							"<LABEL onmouseover=\"this.style.color='#FFFFFF'\" onmouseout=\"this.style.color='black'\">"+titleSegment+"</LABEL>"+
							"</td>"+
							"<td width='14' class='bt1_bg2'>"+
							//"<IMG src='<%=frameroot%>/images/tab/close_03.jpg' id='img_close' align='bottom' onclick='closeWork()'/>"+
							"</td>"+
...
function addPanels(sTitle,sIcon,sUrl,tabId){
	...
	oCel.innerHTML = "<IFRAME id=\"frame_"+tabId+"\" frameBorder=\"0\" scrolling=\"no\" onreadystatechange=\"stateListener(this)\" width=\"100%\" height=\"100%\" src=\""+sUrl+"\" >对不起，您的浏览器不支持IFRAME!</IFRAME>";
	//oRow1.valign = "bottom";	
							...
							<TABLE onselectstart="return false" border=0
								...
								<TR>
									...
									<TD style="width: 105; cursor: hand;" nowrap valign="bottom">
										<img src="<%=frameroot%>/images/tab/arrow1.gif" id="toLeft"
											onMouseOver="scroll_doMouseOver(this)"
											onMouseOut="scroll_doMouseOut(this)" title="向左滚动"
											onClick="scrollTab('PageLeft')" />
										<img src="<%=frameroot%>/images/tab/arrow2.gif" id="toRight"
											onMouseOver="scroll_doMouseOver(this)"
											onMouseOut="scroll_doMouseOut(this)" title="向右滚动"
											onClick="scrollTab('PageRight')" />
										<img src="<%=frameroot%>/images/tab/Back.jpg" title="当前工作区后退"
											onClick="history.back();"
											onMouseOver="this.src='<%=frameroot%>/images/tab/Back_o.jpg'"
											onMouseOut="this.src='<%=frameroot%>/images/tab/Back.jpg'" />
										<img src="<%=frameroot%>/images/tab/refresh_o_03.gif"
											title="刷新当前工作区" onClick="refreshCurrentWork()"
											onMouseOver="this.src='<%=frameroot%>/images/tab/refresh_z_03.gif'"
											onMouseOut="this.src='<%=frameroot%>/images/tab/refresh_o_03.gif'" />
										<img src="<%=frameroot%>/images/tab/close.gif" title="关闭当前工作区"
											onClick="closeWork()"

...
<html>
	...
	<FRAMESET id="container" border="1" frameSpacing="1" cols="180,*" frameBorder="1" bordercolor="#d4d0c7">
		...
		<FRAME name="privil_content" marginWidth="0" marginHeight="0" src="<%=basePath%>/fileNameRedirectAction.action?toPage=theme/theme-bgtMenuContent.jsp" frameBorder="0" scrolling="no">
	</FRAMESET>
	<noframes></noframes>
</html>

...
<%@include file="/common/include/20110118094050.jsp"%>
<!-- 20110118094050.jsp为模板生成的rootPath页面，需要保留-->
<html>
  <head>
  	<title>导航区域</title>
	...
	<script type="text/javascript">
		...
		function bgtdesk(){	
			windowWork.navigate("<%=basePath%>/desktop/desktopWhole!gotoBgtDesktop.action","办公门户");
		}
  ...
  <tr>
    <td  align="center"><a href="#" onclick="hidemenu();"><img name=pic src="<%=root%>/images/ico/jiantou1.jpg" width="56" height="5" border="0"  title="点击隐藏菜单栏"/></a></td>
  </tr>
		...
		<tr>
			<td width="40%">
				<table width="100%" height="20" align="left" border="0" cellpadding="00"
					...
					<tr>
						<td  align="left">
							<web-menu:strongmenu dealclass="com.strongit.tag.web.menu.MenuNode" menus="${menus}" data="${menus2}" root="<%=frameroot%>"/>
						</td>
					</tr>
				</table>
			</td>
								...
								<td nowrap="nowrap" height="28">
									<a href="#" style="color: #FFFFFF"
										...
										<s:if
											test="systemset!=null&&systemset.fastMenuFontSize!=null&&systemset.fastMenuFontSize!=\"\"">
											<span
												style="font-size:<s:property value="systemset.fastMenuFontSize"/>px">办公门户</span>
											</s:if>
											<s:else>
												办公门户
											</s:else>

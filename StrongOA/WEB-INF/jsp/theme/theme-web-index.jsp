...
<frameset rows="170,*"  name="title" cols="*" framespacing="0" frameborder="no" border="0">
  <frame src="<%=path%>/theme/theme!RefreshToolbar.action?pageModelId=40280cf137316b41013731a3ca24000a&limitType=6" name="mainFrame" id="mainFrame"   scrolling="no"  noresize="noresize"  />
  
  <frame src="<%=path%>/fileNameRedirectAction.action?toPage=theme/web-content.jsp" scrolling="no" name="bottomFrame"  noresize="noresize" id="bottomFrame"  />
</frameset>
<noframes>
<body>
</body>

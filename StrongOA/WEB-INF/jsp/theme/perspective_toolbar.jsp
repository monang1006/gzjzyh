	...
	<div class="topMenuDiv">
		...
		<div class="bg_header">
					...
					<div class="header_Function_icon ">
						<ul>
							<li class="header_system_line" style="width:260px;align:left; padding:0;margin-top:6px;">
								<p style="float:left;color:#444;height:16px;line-height:1;padding:7px 0 1px 3px;"><span>当前站点：</span><b>${siteName }</b></p>
			...
			onclick="redirect('/ipp/personalcenter/action/personal!info.action','个人信息','00070001')">
					<img src="<%=themePath%>/image/pic_person.gif"/>&nbsp;&nbsp;${userName }(${userLoginName})
			</div>				
			</div>

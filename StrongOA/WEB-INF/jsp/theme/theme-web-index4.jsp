...
<frameset rows="167,*"  name="title" cols="*" framespacing="0" frameborder="no" border="0">
  <frame src="<%=path%>/theme/theme!RefreshToolbar.action?pageModelId=40288fff384fe0f30138510d2679000d&limitType=6" name="mainFrame" id="mainFrame"   scrolling="no"  noresize="noresize" />
  
  <frame src="<%=path%>/fileNameRedirectAction.action?toPage=theme/web-content4.jsp" scrolling="no" name="bottomFrame"  noresize="noresize" id="bottomFrame" />
</frameset>
<noframes>
<body>
</body>

							...
							<webflex:flexTable name="myTable" width="100%" height="200px" wholeCss="table1"
								...
								<s:if test="state!=1">
									...
									<webflex:flexTextCol caption="<%=column4[1]%>" property="<%=column4[0]%>" align="center"
										showValue="<%=column4[0]%>" width="20%" isCanDrag="false" 
										isCanSort="false" showsize="25"></webflex:flexTextCol>
									<%
										}
									%>
									<%
									...
									<%
										if (column7 != null) {
									%>
									<webflex:flexTextCol caption="<%=column7[1]%>" property="<%=column7[3]%>" align="center"
								...
								<s:else>
									...
									<%
										if (column6 != null) {
									%>
									<webflex:flexTextCol caption="<%=column5[1]%>" property="<%=column6[3]%>" align="center"
										showValue="<%=column6[0]%>" width="15%" isCanDrag="false" isCanSort="false" showsize="5"></webflex:flexTextCol>
									<%
										}
									%>
									<%
										if (column9 != null) {
									%>
									<webflex:flexDateCol caption="<%=column9[1]%>" property="<%=column9[3]%>"
										showValue="<%=column9[0]%>" width="10%" isCanDrag="true" dateFormat="yyyy-MM-dd"
									...
									<%
										if (column10 != null) {
									%>
									<webflex:flexTextCol caption="<%=column10[1]%>" property="<%=column10[3]%>" align="center"
										showValue="<%=column10[0]%>" width="10%" isCanDrag="false" isCanSort="false" showsize="4"></webflex:flexTextCol>
									<%
										}
									%>
								</s:else>

	...
	<body class="contentbodymargin" oncontextmenu="return false;" onload="initMenuT();">
		...
		<div id="contentborder" align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="vertical-align: top;">
				...
				<tr>
					<td height="100%">
						<!--发文处理主办显示列 【文件标题	  发文类别	发文单位	当前办理人	当前部门】	  -->
						<%
						...
						<s:form name="myTableForm" action="/senddoc/sendDoc!hostedby.action">
							<webflex:flexTable name="myTable" width="100%" height="200px" wholeCss="table1"
								...
								<webflex:flexTextCol caption="<%=column3[1]%>" property="<%=column1[0]%>"
									showValue="<%=column3[0]%>" width="40%" isCanDrag="false" isCanSort="false"
									onclick="ViewFormAndWorkflow(this.value);" showsize="25"></webflex:flexTextCol>
								<%
									}
								%>
								<%
									if (column4 != null) {
								%>
								<webflex:flexTextCol caption="<%=column4[1]%>" property="<%=column1[0]%>" align="center"
								...
								<webflex:flexTextCol caption="<%=column7[1]%>" property="<%=column7[3]%>" align="center"
									showValue="<%=column7[0]%>" width="15%" isCanDrag="false" isCanSort="false" showsize="7"></webflex:flexTextCol>
								<%
									}
								%>
							</webflex:flexTable>

	...
	<head>
		...
		<script type="text/javascript">
			...
			function openDoc() {
				...
				var ret=WindowOpen("<%=root%>/senddoc/sendDoc!viewHostedBy.action?instanceId="+instanceId+"&state="+ $("#state").val(),'hostedby',width, height,"");
			}
			//处理状态（查看流程图）
						...
						<s:form name="myTableForm" action="/senddoc/sendDoc!myTodo.action">
							<webflex:flexTable name="myTable" width="100%" height="200px" wholeCss="table1"
								...
								<webflex:flexTextCol caption="<%=column2[1]%>" property="<%=column1[0]%>"
									showValue="<%=column2[0]%>" width="52%" isCanDrag="false" isCanSort="false"
								...
								<webflex:flexDateCol caption="<%=column3[1]%>" property="<%=column3[3]%>"
									showValue="<%=column3[0]%>" width="15%" isCanDrag="true" dateFormat="yyyy-MM-dd HH:mm:ss"

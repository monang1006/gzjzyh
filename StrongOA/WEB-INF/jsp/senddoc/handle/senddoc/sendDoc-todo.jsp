					...
					<td height="100%">
						...
						<s:form name="myTableForm" id="myTableForm"
							...
							<webflex:flexTable name="myTable" width="100%" height="200px"
								...
								if (column4 != null) {
								%>
								<webflex:flexTextCol caption="<%=column4[1]%>" align="center"
								...
								if (column5 != null) {
								%>
								<webflex:flexTextCol caption="<%=column5[1]%>" align="center"
								...
								if (column6 != null) {
								%>
								<webflex:flexTextCol caption="<%=column6[1]%>" align="center"
								...
								if (column7 != null) {
								%>
								<webflex:flexTextCol caption="<%=column7[1]%>" align="center"

	...
	<body class="contentbodymargin" onload="initMenuT();">
						                 	         ...
						                 	         <td width="4"><img src="<%=frameroot%>/images/bt_r.jpg"/></td>
						                 	          <td width="5"></td>
														<td width="4"><img src="<%=frameroot%>/images/bt_l.jpg"/></td>
									                 	...
									                 	<td width="5"></td>
									                 	<td width="4"><img src="<%=frameroot%>/images/bt_l.jpg"/></td>
									                 	<td class="Operation_list" onclick="sendDoc();"><img src="<%=root%>/images/operationbtn/Submit.png"/>&nbsp;提&nbsp;交&nbsp;</td>
									                 	<td width="4"><img src="<%=frameroot%>/images/bt_r.jpg"/></td>
									                 	<td width="5"></td>
									                 	<td width="4"><img src="<%=frameroot%>/images/bt_l.jpg"/></td>
						...
						<s:form id="myTableForm" action="/senddoc/sendDoc!draft.action">
							...
							<webflex:flexTable name="myTable" width="100%" height="200px"
								...
								<webflex:flexCheckBoxCol caption="选择" property="<%=column1[0]%>"
									showValue="<%=column1[3]%>" width="3%" isCheckAll="true"
								...
								<webflex:flexTextCol caption="<%=column2[1]%>"
									property="<%=column2[3]%>" showValue="<%=column2[0]%>" onclick="processDoc1();"
									width="97%" isCanDrag="false" isCanSort="false" showsize="50"></webflex:flexTextCol>
								<%
									}
								%>
      ...
      function initMenuT(){
        ...
        var item = null;
            ...
            sMenu.addItem(item);
	        item = new MenuItem("<%=root%>/images/operationbtn/add.png","新建","newDoc",1,"ChangeWidthTable","checkMoreDis");
	        sMenu.addItem(item);
	        item = new MenuItem("<%=root%>/images/operationbtn/Submit.png","提交","sendDoc",1,"ChangeWidthTable","checkOneDis");
	        sMenu.addItem(item);

						...
						<s:form name="myTableForm" action="/senddoc/sendDoc!hostedby.action">
							<webflex:flexTable name="myTable" width="100%" height="200px" wholeCss="table1"
								...
								<webflex:flexTextCol caption="<%=column2[1]%>" property="<%=column1[0]%>"
									showValue="<%=column2[0]%>" width="56%" isCanDrag="false" isCanSort="false"
								...
								<webflex:flexTextCol caption="<%=column5[1]%>" property="<%=column5[3]%>" align="center"
									showValue="<%=column5[0]%>" width="14%" isCanDrag="false" isCanSort="false" showsize="7"></webflex:flexTextCol>
								<%
									}
								%>
							</webflex:flexTable>

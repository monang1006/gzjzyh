			...
			*/
			function doFetchTask(taskId){
				...
				if(workfname=="收文办件登记"||workfname=="呈阅件登记"){
					$.post("<%=root%>/senddoc/sendDoc!isdjfb.action", {
								taskId : taskId,workflowName :workfname,instanceId : instanceId
							}, function(data) {
								if (data == "error") {
									...
									<table border="0" align="right" cellpadding="00" cellspacing="0">
										<tr>
											...
											<td width="4"><img src="<%=frameroot%>/images/bt_l.jpg"/></td>
						                 	...
						                 	<td width="5"></td>
						                 	<s:if test="state!=1">
												<s:if test="#request.sends!=1 && #request.suporgcode==001">
													<td width="4"><img src="<%=frameroot%>/images/bt_l.jpg"/></td>
				...
				<tr>
					<td height="100%">
						<s:form name="myTableForm" id="myTableForm" action="/senddoc/sendDoc!processed.action">
							<!--个人办公已办显示列 【标题	发起时间	当前办理人	当前部门】	  -->
							<!--个人办公办结显示列 【标题	发起时间	办结时间	      主办人】	  -->
							<%
								List showColumnList = new ArrayList((List) request.getAttribute("showColumnList"));
									...
									String[] column2 = null; //标题
									String[] column3 = null; //发起时间
									String[] column4 = null; //上一步处理人
									String[] column5 = null; //所在部门
									String[] column6 = null; //PNG
									String[] column7 = null; //办结时间
									String[] column8 = null; //主办人员
							...
							<webflex:flexTable name="myTable" width="100%" height="200px" wholeCss="table1"
								...
								<s:if test="state!=1">
									...
									<webflex:flexTextCol caption="<%=column4[1]%>" property="<%=column4[3]%>" align="center"
										showValue="<%=column4[0]%>" width="12%" isCanDrag="false" isCanSort="false" showsize="5"></webflex:flexTextCol>
									<%
										}
									%>
									<%
									...
									<webflex:flexTextCol caption="<%=column5[1]%>" property="<%=column5[3]%>" align="center"
										showValue="<%=column5[0]%>" width="13%" isCanDrag="false" isCanSort="false" showsize="7"></webflex:flexTextCol>
									<%
										}
									%>
								</s:if>
								<s:else>
									...
									%>
									<webflex:flexTextCol caption="<%=column2[1]%>" property="<%=column1[0]%>"
										showValue="<%=column2[0]%>" width="65%" isCanDrag="false" isCanSort="false"

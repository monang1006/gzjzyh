	...
	<body class="contentbodymargin" onload="initMenuT();">
		...
		<div id="contentborder" align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td height="100%">
					<!--收文处理回收站显示列 【收文编号	文件标题	来文单位	来文字号	来文日期	当前办理人	当前部门】	  -->
							...
							<webflex:flexTable name="myTable" width="100%" height="200px"
								...
								<s:if test="state!=1">
									...
									<webflex:flexCheckBoxCol caption="选择"
										...
										width="10%" isCheckAll="true" isCanDrag="false"
									...
									<webflex:flexTextCol caption="<%=column4[1]%>"
										property="<%=column1[0]%>" showValue="<%=column4[0]%>"
										width="30%" isCanDrag="false" isCanSort="false"
									...
									if (column7 != null) {
									%>
									<webflex:flexDateCol caption="<%=column7[1]%>"
									...
									if (column8 != null) {
									%>
									<webflex:flexTextCol caption="<%=column8[1]%>"
								...
								<s:else>
									...
									<webflex:flexTextCol caption="<%=column4[1]%>"
										property="<%=column1[0]%>" showValue="<%=column4[0]%>"
										width="35%" isCanDrag="false" isCanSort="false"
									...
									if (column10 != null) {
									%>
									<webflex:flexDateCol caption="<%=column10[1]%>"
										property="<%=column10[3]%>" showValue="<%=column10[0]%>"
										width="10%" isCanDrag="true" dateFormat="yyyy-MM-dd"
										isCanSort="true"></webflex:flexDateCol>
									<%
									}
									...
									if (column11 != null) {
									%>
									<webflex:flexTextCol caption="<%=column11[1]%>"
										property="<%=column11[3]%>" showValue="<%=column11[0]%>"
										width="12%" isCanDrag="false" isCanSort="false" showsize="5"></webflex:flexTextCol>
									<%
									}
									%>

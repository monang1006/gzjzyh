...
<html>
	...
	<body oncontextmenu="return false;" style="margin-top:5px;">
		<strong:workflow title="总计" isPop="false" href="/senddoc/sendDoc!myReturn.action?handleKind=${handleKind}&type=${type}" typeList="${workflowTypeList}" workflowMap="${workflowMap}"/>
		  ...
		  function lbst(){//列表视图
		  	window.location.href="<%=path%>/work/work!listReturn.action?state=${state}&workflowType=${workflowType}&handleKind=${handleKind}&filterSign=${filterSign}&excludeWorkflowType=${excludeWorkflowType}";
		  }		
			 /*	 */
		</script>
	</body>

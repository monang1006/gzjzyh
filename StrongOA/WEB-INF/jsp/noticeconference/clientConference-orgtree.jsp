...
<%--			<tree:strongtree title="组织机构"  check="false" dealclass="com.strongit.oa.address.util.AddressOrgPersonDeal" data="${groupLst}" target="project_work_content"  />	--%>
			<tree:strongtree title="组织机构"  check="false"  titlecheck="false"  dealclass="com.strongit.oa.noticeconference.util.SeatSetPersonDeal" data="${groupLst}" target="project_work_content"  iconpath="frame/theme_gray/images/"/>	
		</DIV>
	</BODY>
</HTML>

...
<html>
 ...
 <table width="100%">
   ...
   <div style="font-weight:bolder; font-size:18px; text-align:center; width:80%;height:28px;">人员编辑量统计表</div>
    <table cellpadding="1" cellspacing="1" width='80%' class="tabl2" >
    <tr height="25px;">
   <td align="center"  bgcolor="#E1E1E1">序号</td>
   <td align="center" bgcolor="#E1E1E1">编辑者名称</td>
   <td align="center" bgcolor="#E1E1E1">文章数</td>
   </tr>

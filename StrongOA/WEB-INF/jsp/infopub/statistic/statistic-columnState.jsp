...
<html>
  ...
  <hr></td></tr><tr><td> 
   ...
   <div style="font-weight:bolder; font-size:18px; text-align:center; width:80%;height:28px;">${columnName }栏目统计表</div>
    <table cellpadding="1" cellspacing="1" width='80%' class="tabl2" >
    <tr height="25px;">
   <td align="center"  bgcolor="#E1E1E1">序号</td>
   <td align="center" bgcolor="#E1E1E1">发布状态</td>
   <td align="center" bgcolor="#E1E1E1">统计数量</td>
   </tr>
    <c:forEach items="${list}" var="vo" varStatus="index">
   <tr height="25px;">
   <td align="center" width="10%">${index.index+1 }</td>
   <td align="left" style="padding-left:10px;" width="60%">${vo.columnName } </td>
   <td align="center" width="15%">${vo.pubCount }</td></tr>
   </c:forEach>
   </table>
   </td>
   </tr>

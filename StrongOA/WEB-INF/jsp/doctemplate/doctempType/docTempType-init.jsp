...
<%--								size="32" value="${model.docgroupId}">--%>
							...
							<table width="100%" height="10%" border="0" cellpadding="0"
								...
								<tr>
									...
									<td class="td1" colspan="3" align="left">
										<input id="docgroupName" name="model.docgroupName" type="text" style="border:1px solid #b3bcc3;background-color:#ffffff;"
								...
								<s:else>
									<tr>
										...
										<td class="td1" colspan="3" align="left">
												<s:select list="#{'0':'word控件','1':'编辑器'}" id="docgroupType" style="background-color:#ffffff" name="model.docgroupType">
												</s:select>											

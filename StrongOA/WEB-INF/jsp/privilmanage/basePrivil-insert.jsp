			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td height="100%">
						...
						<s:form id="submitForm" action="/privilmanage/basePrivil!save.action" method="post" theme="simple">
						<input  type="reset" id="ret" style="display: none;"/>
							<input type="hidden" id="privilId" name="privilId" value="${model.privilId}">
							<input type="hidden" id="viewChangeFlag" name="viewChangeFlag" value="${viewChangeFlag}">
							<table width="100%" height="10%" border="0" cellpadding="0" cellspacing="0" align="center" class="table1">
								<tr>
								...
								<tr>
									...
									<td class="td1" colspan="3" align="left">
										<textarea rows="4" id="privilCode" name="model.privilCode"
											style="width:80%">${model.privilCode}</textarea>

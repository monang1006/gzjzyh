	...
	<BODY class=contentbodymargin leftmargin="2" topmargin="5">
		...
		<DIV id=treecontentborder>
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="20%" style="vertical-align: top;">
				<form action="<%=path%>/rolemanage/baseRole!saveUser.action" method="post">
									...
									<table border="0" align="right" cellpadding="00" cellspacing="0">
										<tr>
											<td width="7"><img src="<%=frameroot%>/images/ch_h_l.gif"/></td>
						                 	<td class="Operation_input" onclick="selectUsers();">&nbsp;确&nbsp;定&nbsp;</td>
...
<script>
		...
		function lazyLoadSubTree(aNode, aExpandOrClose, isFilter){
			if(aNode.others == "user"){
				...
				$.getJSON(scriptroot + "/rolemanage/baseRole!lazyLoadUserAndChildOrgs.action",{orgSyscode: aNode.id}, function(jsons){

		...
		<table  width="100%" border="0" cellpadding="0" cellspacing="1"  class="table1">
			...
			<tr>
				...
				<td colspan="3" class="td1" width="75%">
					<input type="text" name="mailaddress" id="mailaddress" title="多个收件人之间请用英文逗号分隔" style="width:100% "/>
				</td>
			</tr>
				...
				<td id="attfile" colspan="3" class="td1" width="75%">
					...
					<s:if test="#request.attList!=null">
						<s:iterator value="#request.attList" status="statu" id="att">
							<div id=div<s:property value="#att.attachId"/> >[<a href="#" onclick="deldbobj('<s:property value="#att.attachId"/>')">删除</a>]<s:property value="#att.attachName" /></div><input type="hidden" name="dbobj" id="<s:property value="#att.attachId"/>" value=<s:property value="#att.attachId"/>  />
						</s:iterator>
					</s:if>
				</td>
			</tr>

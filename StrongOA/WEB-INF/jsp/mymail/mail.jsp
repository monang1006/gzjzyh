		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
			  ...
			  $("#test1").click(function(){
				...
				d2x.css("position","absolute");
				d2x.css("left",offset.left);
				d2x.css("top",offset.top+$("#test1").height()+3);
				d2x_click = true;
				return false;
			  });
			...
			function FontState(state,content){
			
				if(state=="1"){
					return content;
				}else{
					return "<font color=black face='黑体' size=2>"+content+"</font>";
				}
...
<s:form id="myTableForm" action="/mymail/mail.action" method="get">
  ...
  <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="00">
          <tr>
            ...
            <table border="0" align="right" cellpadding="00" cellspacing="0">
                <tr>
                  ...
                  <td width="5"></td>
                  <td><a class="Operation" href="#" onclick="retell()"><img src="<%=root%>/images/ico/banli.gif" width="15" height="15" class="img_s">回复</a></td>
                  <td width="5"></td>
                  ...
                  <td width="5"></td>
                  <%--<td width="50"><a class="Operation" href="#" onclick="gotoAddPro()"><img src="<%=root%>/images/ico/kaishi.gif" width="15" height="15" class="img_s">添加</a></td>
                  <td width="5"></td>
                  <td width="80"><span class="Operation" id="test1" style="cursor:hand"><img src="<%=root%>/images/ico/xiaohui.gif" width="15" height="15" class="img_s">更多操作</span></td>
                  <td width="5"></td>
                  --%>
                </tr>
            </table>
	     ...
	     <webflex:flexTable name="myTable" width="100%" height="100%" wholeCss="table1" property="0" isCanDrag="true" isCanFixUpCol="true" clickColor="#A9B2CA" footShow="showCheck" getValueType="getValueByArray" onclick="quicklyVeiwMail(this.value)" collection="${page.result}" page="${page}">
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table1">
			     <tr>
			       <td width="5%" align="center"  class="biao_bg1"><img id="img_sousuo" style="cursor: hand;"  src="<%=frameroot%>/images/perspective_leftside/sousuo.gif" width="17" height="16"></td>
			...
			<webflex:flexTextCol caption="附件" valuepos="3" valueshowpos="javascript:isAtt(3)" width="6%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
			<webflex:flexTextCol caption="类型" valuepos="4" valueshowpos="javascript:viewPri(4)" width="6%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
			<webflex:flexTextCol caption="发件人"  valuepos="5" valueshowpos="javascript:FontState(2,5)" width="20%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
			<webflex:flexTextCol caption="主题" valuepos="0" valueshowpos="javascript:FontState(2,1)" width="27%" isCanDrag="true" isCanSort="true" onclick="toViewMail(this.value)"></webflex:flexTextCol>
			...
			<webflex:flexTextCol caption="大小(KB)" valuepos="7" valueshowpos="javascript:FontState(2,7)" width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
		</webflex:flexTable>
	</td>
  </tr>
</table>
	...
	<div id="d2x" class="Operation">
		<div style="border-top:1px solid #fff; border-left:1px solid #fff; border-right:1px solid #B4C5E0; border-bottom:1px solid #B4C5E0; padding:5px;">
		    <table width="100%" border="0" cellspacing="0" class="tbaCss" cellpadding="0">
		      	<tr>
		      		<td onclick="del()" onmouseout="this.className='myshow'" onmouseover="this.className='myhidden'">删除邮件</td>
		      	</tr>
		      	<tr>
		      		<td onclick="realDel()" onmouseout="this.className='myshow'" onmouseover="this.className='myhidden'">彻底删除</td>
				</tr>
		    </table>
		</div>
	</div>
...
function initMenuT(){
	...
	sMenu.addItem(item);
	item = new MenuItem("<%=root%>/images/ico/zhuanjiaoxiayibu.gif","回复","retell",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
	item = new MenuItem("<%=root%>/images/ico/perspective_leftside/shanchu.gif","删除","del",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);
...
function retell(){
	...
	if(relId==null||relId==""){
		...
		if(relId.indexOf(",")!=-1){
			...
			OpenWindow('<%=root%>/mymail/mail!reply.action?boxId=${boxId}&sendid='+relId, '700', '400', window);
		}
	}
}
...
function resend(){
	...
	if(reId==null||reId==""){
		...
		if(reId.indexOf(",")!=-1){
			...
			OpenWindow('<%=root%>/mymail/mail!tran.action?boxId=${boxId}&sendid='+reId, '700', '400', window);
		}
	}
}
...
function gotoSetPro(){
	var boo=OpenWindow('<%=root%>/mymail/mailBox!edit.action?type=showedit&id=${boxId}', '400', '320', window);
	if(boo=="true"){
		window.parent.parent.mail_manager_tree.location.reload();
	}
}

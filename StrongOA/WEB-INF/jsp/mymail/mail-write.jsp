...
<script language="javascript">
	...
	function aftersave(msg){
		if(msg=="true"){
			if(confirm("邮件草稿保存成功，是否关闭该窗口?")==true){
				window.close();
			}
		}else{
			alert("邮件保存失败！");
				...
				<td width="80%">
					<table border="0" align="right" cellpadding="00" cellspacing="0">
		                <tr>
		                  ...
		                  <td width="5"></td>
		                  <td><a class="Operation" href="#" onclick="saveDraft()"><img src="<%=root%>/images/ico/baocun.gif" width="15" height="15" class="img_s">存草稿</a></td>
		                  <td width="5"></td>
		                  <td><a class="Operation" href="#" onclick="window.close();"><img src="<%=root%>/images/ico/guanbi.gif" width="15" height="15" class="img_s">关闭</a></td>
		                  <td width="5"></td>
		                </tr>
		            </table>
				</td>
		...
		<table  width="100%" border="0" cellpadding="0" cellspacing="1"  class="table1">
			...
			<tr>
				...
				<td colspan="3" class="td1" width="75%">
					<input type="text" check="false" name="mailaddress" id="mailaddress" title="多个收件人之间请用英文逗号分隔" style="width:100% "/>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" class="td1" width="75%">
					<input type="text" name="subject" id="subject" style="width:100% " onKeyUp="ischanged = true;" maxlength="50"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4" class="td1" width="75%">
					<table width="100%" height="38px;" style="FILTER:progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#ededed,endColorStr=#ffffff);">
						<tr>
							<td>&nbsp;</td>
							<td width="15%">
							</td>
							<td width="85%">
								<table border="0" align="left" cellpadding="00" cellspacing="0">
					                <tr>
					                  <td width="*"></td>
					                  <td><a class="Operation" href="#" name="fsbutton" id="fsbutton" >发送</a></td>
					                  <td width="5"></td>
					                  <td><a class="Operation" href="#" onclick="saveDraft()">存草稿</a></td>
					                  <td width="5"></td>
					                  <td><a class="Operation" href="#" name="cancle" id="cancle" onclick="window.close();">关闭</a></td>
					                  <td width="5"></td>
					                </tr>
					            </table>
							</td>

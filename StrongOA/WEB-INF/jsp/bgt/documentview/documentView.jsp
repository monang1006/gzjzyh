		...
		<div id="contentborder" align="center"">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td height="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<s:form id="myTableForm" action="/bgt/documentview/documentView.action" method="get">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td width="40%"  class="biao_bg1"><input name="processNameTEXT" id="processNameTEXT" type="text" style="width=100%" class="search" title="输入标题" value="${processName }"></td>
										<td width="20%"  class="biao_bg1"><input name="startUserNameTEXT" id="startUserNameTEXT" type="text" style="width=100%" class="search" title="输入主办人员" value="${startUserName }"></td>
										<td width="17%" align="center" class="biao_bg1"><strong:newdate  name="searchDate" id="searchDate" width="100%" skin="whyGreen" isicon="true"  classtyle="search" title="输入启动日期"/></td>
								...
								<webflex:flexTextCol caption="标题" property="businessName"
									showValue="businessName" width="74%" isCanDrag="true" isCanSort="true" showsize="40"></webflex:flexTextCol>
									
									<webflex:flexTextCol caption="当前处理人" width="10%" property="startUserName"
									...
									isCanSort="false"></webflex:flexCheckBoxCol>
								<webflex:flexTextCol caption="标题" property="businessName"
									showValue="businessName" width="62%" isCanDrag="true" isCanSort="true" showsize="40"></webflex:flexTextCol>
									...
									showValue="workflowName"
								 	width="15%" isCanDrag="true" isCanSort="true" showsize="7"></webflex:flexTextCol>
								 	</s:else>
							</webflex:flexTable>
							<s:actionmessage />
						</s:form>
...
function initMenuT(){
	...
	//sMenu.addItem(item);
	item = new MenuItem("<%=root%>/images/ico/tb-change.gif","查看","viewMonitorData",1,"ChangeWidthTable","checkOneDis");
	sMenu.addItem(item);

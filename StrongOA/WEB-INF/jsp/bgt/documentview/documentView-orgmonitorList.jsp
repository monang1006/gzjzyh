						...
						<s:form id="myTableForm" action="/bgt/documentview/documentView!monitorList.action" method="get">
							...
							<webflex:flexTable name="myTable" width="100%" height="370px"
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table1_search">
									<tr>
										...
										&nbsp;&nbsp;标题：&nbsp;<input name="processNameTEXT" id="processNameTEXT" style="width: 90px;" type="text" class="search" title="请您输入标题" value="${processName }">
							       		&nbsp;&nbsp;启动日期：&nbsp;<strong:newdate  name="searchDate" id="searchDate" skin="whyGreen" isicon="true"  classtyle="search" title="请输入启动日期" dateform="yyyy-MM-dd"/>
							       		&nbsp;&nbsp;处室名称：&nbsp;<s:select id="orgIds" name="orgIds" list="%{OrgNameMapIds}" listKey="value" listValue="key"  headerKey="" headerValue="全部处室" classtyle="search" onchange='$("#img_sousuo").click();'>
										</s:select>
								...
								<webflex:flexTextCol caption="标题" property="instanceId"
									showValue="businessName" width="74%" isCanDrag="true" isCanSort="true" showsize="42"
									 onclick="ViewFormAndWorkflow(this.value);" ></webflex:flexTextCol>
									
								<webflex:flexTextCol caption="签收处室" width="10%" property="deptName"
									showValue="deptName" align="center"

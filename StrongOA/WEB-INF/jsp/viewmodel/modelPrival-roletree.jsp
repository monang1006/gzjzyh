					...
					<td height="10px">
						<div class="dtree">
						  ...
						  function setNodeItem(checkFlag, id, name) {
						      if (checkFlag) {
						        parent.addOption("role", name, id);						        
							      } else {
						        parent.removeOption("role", name, id);
						      }
						  }
...
<%--					        }--%>
						  ...
						  var d = new dTree('d');
						  d.add('${topTreeNodeId}','-1','所有角色','','','','<%=root%>/workflow/images/tree/folder_closed.gif','2');
						  ...
						  parent.frameInitChecked('modelPrival-roletree');
						</script>
						</div>
					</td>
				</tr>

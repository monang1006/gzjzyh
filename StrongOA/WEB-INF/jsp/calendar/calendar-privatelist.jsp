...
<HTML>
	...
	<!--<script language='javascript' src='<%=path%>/common/js/common/search.js'></script>-->
		...
		//添加新事务
			function addTask(){
				var url = "<%=path%>/calendar/calendar!input.action?ifleader="+ifleader.value;
				var a = window.showModalDialog(url,window,'dialogWidth:750px;dialogHeight:630px;help:no;status:no;scroll:no');
				if("reload"==a){
					window.location.reload();
				}
				 ...
				 <tr>
				 	<td>
						...
						<webflex:flexTable name="myTable" width="100%" height="100%" wholeCss="table1" property="0" isCanDrag="true" isCanFixUpCol="true" clickColor="#A9B2CA" footShow="showCheck" getValueType="getValueByArray" collection="${page.result}" page="${page}">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table1_search">
					         	 <tr>
							       ...
							       <div style="float: left; ">
							       		&nbsp;&nbsp;活动主题：&nbsp;<input name="searchcalTitle" style="width: 140px;background-color:#ffffff" id="searchcalTitle" type="text" class="search" title="请您输入活动主题" value="${model.calTitle }">
							       	</div>
							       	...
							       	<div style="float:left; width: 240px;">
							       		&nbsp;&nbsp;活动分类：&nbsp;<input name="searchactivityName" style="width:140px;background-color:#ffffff" id="searchactivityName" type="text" class="search" title="请您输入分类" value="${model.toaCalendarActivity.activityName }">
							       	</div>
							       	<div style="float: left;width: 170px;padding-top: 5px;">
							      	 	&nbsp;&nbsp;有无提醒：&nbsp;<s:select   style="width:70px" name="model.calHasRemind" style="background-color:#ffffff" list="#{'':'全部','0':'无','1':'有'}" listKey="key" listValue="value" onchange='$("#img_sousuo").click();'/>
							       	</div>
							       	<div style="float: left; width: 335px ">
							       		&nbsp;&nbsp;活动地点：&nbsp;<input style="width: 140px" name="searchcalPlace" style="background-color:#ffffff" id="searchcalPlace" type="text" class="search" title="请您输入活动地点" value="${model.calPlace }">
							...
							<webflex:flexTextCol caption="活动主题" valuepos="0" valueshowpos="1" width="25%" isCanDrag="true" isCanSort="true" onclick="view(this.value)" showsize="18"></webflex:flexTextCol>
							<webflex:flexTextCol caption="活动分类" align="center" valuepos="6" valueshowpos="6" width="10%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
							...
							<webflex:flexTextCol caption="活动地点" align="center" valuepos="7" valueshowpos="7" width="20%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
							<webflex:flexTextCol caption="有无提醒" align="center" valuepos="1" valueshowpos="javascript:hasRemind(8);" width="13%" isCanDrag="true" isCanSort="true"></webflex:flexTextCol>
						  </webflex:flexTable>

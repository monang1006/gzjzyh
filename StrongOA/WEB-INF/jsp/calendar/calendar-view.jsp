    ...
    var calendar = new Calendar(
        'calendar1', 
        {
          ...
          dblclickSchedule:   function(schedule) {		//双击事务图标执行 函数
          	...
          	var url = "<%=path%>/calendar/calendar!input.action?ifleader="+$(ifleader).value+"&calendarId="+calId;
...
function showAddwindow(x,y){
    ...
    +'<TD STYLE="color:#3F3F38;font:14px " WIDTH=\"100%\" >'
    ...
    +'&nbsp;&nbsp;<input type=\"submit\" value=\"快速新建\" style=\"font-size:14px\" class=\"input_bg\" onclick=\"addSchedule();addwindow.style.display=\'none\'\">&nbsp;'
    +'<input type=\"submit\" value=\"高级选项\"  style=\"font-size:14px\" class=\"input_bg\" onclick=\"parent.addTask();addwindow.style.display=\'none\'\">'

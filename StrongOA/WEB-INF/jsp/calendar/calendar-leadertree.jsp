...
$(document).ready(function(){
	simpleTreeCollection = $('.simpleTree').simpleTree({
		...
		afterClick:function(node){
			...
			parent.cal_content.document.location="<%=path%>/calendar/calendar!viewleader.action?inputType=leader&userId="+userId;
		},
...
<DIV id=contentborder align="left">
	<ul class="simpleTree">
		<li class="root" id='1'><label style="cursor: hand;" id="rootSpan">组织用户</label>
			<ul id="groupTree">
				<% 
				List  list= (List)request.getAttribute("leaderList");

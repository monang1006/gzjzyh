...
<html>
	...
	//跳转页面 到搜索列表
			function gotoList(){
				location = "<%=path%>/calendar/calendar!searchlist.action?inputType="+"share";
			}
			 var calendar = null;
	</script>
</head>
				            ...
				            <td colspan="3" class="table_headtd">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="00">
												<tr>
													...
													<td align="left">
														<strong id="cal_page_title">查看共享日程</strong>
													</td>
													<td align="right">
...
//   		alert("setSchedules()-->\n\n开始时间为:"+startD+"\n结束时间为:"+endD);
  		var myAjax = new Ajax.Request(
                ...
                {
                    parameters : 'termStart='+startD+'&termEnd='+endD+"&inputType=share&userId=${userId}",
                    method:  'post', 
...
function closeAddwindow(){ 
  ...
  <div id="addwindow" style="border:5px; display:none; position: absolute; background-color:#FFFF99;">
  </div>

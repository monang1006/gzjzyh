 ...
 * 
 */
public class RtxSignUserDetailServiceImpl implements UserDetailsService {
	@Autowired
	...
	public UserDetails loadUserByUsername(String userName)
		...
		List<TUumsBasePrivil> privils = userService.getPrivilInfosByUserLoginName(user.getUserLoginname(), "1",
						"1", "1");
		if (privils != null) {

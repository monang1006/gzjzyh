...
public class EnumColTag extends TableColTag {
	...
	public String innerHTML(Object valueid,Object showvalue,Object onclick,Object ondbclick,Object map){
		...
		out.append("<td class=\""+tdcss+"\" align=\""+align+"\" onmousemove=\"moveCol(this,document.getElementById('"+tablename+"_div'))\" value=\""+valueid+"\"");
		...
		out.append(">");	
		if(map!=null&&((HashMap) map).get(showvalue)!=null)
			out.append(((HashMap) map).get(showvalue));
		else
	...
	public HashMap getMapobj() {
		return mapobj;
	}

	public void setMapobj(HashMap mapobj) {
		this.mapobj = mapobj;
	}
	...
	public void doStartHtmml() {
		...
		flextag.getCellList().add(new TableColHelp(getProperty(),getShowValue(),getValuepos(),getValueshowpos(),getOnclick(),getOndblclick(),getMapobj(),this));
	}

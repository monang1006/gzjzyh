...
public class JdbcWordTemplateService
{
	private JdbcTemplate template;
	private SessionFactory sessionFactory;
	
	public Page<WordTemplateDto> getTemplates(final Page<WordTemplateDto> pagePl,String tTitle)
	{
		String selectCount = "select count(*) ";
		String select = "select t.wt_id,t.wt_title,t.wt_date  ";
		String from = "from t_info_base_word_template t ";
		
		String  where = "";
		if(!tTitle.equals("")&&!tTitle.equals(null)){
			where = "where t.wt_title like '%" + tTitle + "%' ";
		}
		String order = "order by t.wt_date desc limit ? offset ? ";
		...
		List<WordTemplateDto> rets = template.query(sql, new PreparedStatementSetter(){
		...
		}, new BeanPropertyRowMapper(WordTemplateDto.class));

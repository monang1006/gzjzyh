...
public class RecDealTreeArchiveDocTree extends IDealTreeNode {
	...
	public String getUrl() {
		if(getTagParentId()!=null&&!"".equals(getTagParentId())){
			return "receives/archive/archiveDoc.action?treeValue="+getTagParentId()+","+getTagNodeId()+"&treeType=4";
			}else{
				return "receives/archive/archiveDoc.action?treeValue="+getTagNodeId()+"&treeType=4";
			}
	}

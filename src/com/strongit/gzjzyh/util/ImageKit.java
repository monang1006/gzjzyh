...
public class ImageKit {
	 ...
	 * 根据尺寸图片居中裁剪
	 */
	public static void cutCenterImage(String imageFormat, String src, String dest, int w, int h)
			throws IOException {
	 ...
	 * 图片裁剪二分之一
	 */
	public static void cutHalfImage(String imageFormat, String src, String dest) throws IOException {
		Iterator iterator = ImageIO.getImageReadersByFormatName(imageFormat);
		ImageReader reader = (ImageReader) iterator.next();
		InputStream in = new FileInputStream(src);
		ImageInputStream iis = ImageIO.createImageInputStream(in);
	...
	public static void cutImage(String imageFormat, String src, String dest, int x, int y, int w,

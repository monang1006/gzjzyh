...
public class TimeKit {
	 ...
	 * 
	 * 
	 * @param1: String disply 时间显示格式 return String　返回当前时间格式字符串
	 */
	 ...
	 */
	public final static Date getDateTimeByString(String date) {
	 ...
	 * 
	 * 
	 * @param1: Calendar cal　时间对象 return String　返回格式化后时间字符串（年-月-日）
	 */
	 ...
	 * 
	 * 
	 * @param2: int m　增加月数 return Date　返回加月数后的时间对象
	 */
	public final static Date getDateAddMonthByString(String baseDate, int m)
	 ...
	 * 
	 * 
	 * @param2: Date toDate　结束时间对象 return int　返回结束时间对象减开始时间对象的月份差
	 */
	public final static int getDifferenceBetweenDate(Date fromDate, Date toDate) {
		...
		return (toDateCal.get(Calendar.YEAR) - startDateCal.get(Calendar.YEAR))
				* 12
				+ (toDateCal.get(Calendar.MONTH) - startDateCal
						.get(Calendar.MONTH));

...
public class DealSearchBorrowTreeNode extends IDealTreeNode{
	...
	public String getUrl() {
		// TODO 自动生成方法存根
		return "archive/archivefolder/archiveFolder.action?archiveSortId="+getTagNodeId()+"&moduletype=searchborrowFile";
	}

 ...
 *
 */
public class SendDocRegistInAction implements ActionHandler{
	...
	public void execute(ExecutionContext executionContext) throws Exception {
		//获取签收信息
		SendDocRegistManager manager = (SendDocRegistManager)ServiceLocator.getService("sendDocRegistManager");

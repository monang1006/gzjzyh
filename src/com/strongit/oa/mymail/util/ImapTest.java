...
public class ImapTest {       
    ...
    public ImapTest(MimeMessage mimeMessage) {       
...
//        fileName = UIDGenerator.getUID();   
    ...
    public static void main(String args[]) throws Exception {      
        ...
        URLName urln = new URLName("imap", "imap.qq.com", 143, null,"344168368", "77865512303");      
        ...
        for (int i = 0; i < message.length; i++) {   
            pmm = new ImapTest((MimeMessage) message[i]);    
...
//            pmm.getMailContent((Part) message[i]);     
            ...
            System.out.println(pmm.getMailContent((Part)(message[i].getContent())));  

 ...
 * 
 */
package com.strongit.oa.webservice.server.rtx2010;
...
/**
 * @author 
 *   @date Dec 3, 2011 4:34:41 PM
 *   @Description: TODO(rtx2010提供的服务) 
 *   @throws
 */
public class rtx2010WebService {
...
//					childDeptIdList.add(childDeptId);
					childDeptIdList =childDeptIdList +childDeptId+",";
				}
			} 
			if(!childDeptIdList.equals("")){
				childDeptIdList = childDeptIdList.substring(0, childDeptIdList.length()-1);
			} 
		}
...
//			ToaImConfig config = new ToaImConfig();

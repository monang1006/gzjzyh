package com.strongit.oa.webservice.client.workflow;
...
public class WorkFlowClient extends TestCase {
	...
	public void testLoadFormData() throws Exception  {
		...
		Object[] params = new Object[]{"ff8080812fddec2c012fde23f86a0050","2590933"};//938022,
		String ret = (String)call.invoke(params);
		System.out.println(ret);
	}
	...
	public void testGetToDo() throws Exception {
		...
		Object[] params = new Object[]{"ff8080812fddec2c012fde23f86a0050",null,null,"1","20",null,null};
		String ret = (String)call.invoke(params);
		System.out.println(ret);
	}
	...
	public void testLoadContent() throws Exception {
		...
		Object[] params = new Object[]{"517404"};
		String ret = (String)call.invoke(params);
		System.out.println(ret);
	}
...
//	}
	...
	public void testGetNextTransitions() throws Exception  {
		...
		call.setTargetEndpointAddress(url);
		call.setOperationName("getNextTransitions");
		Object[] params = new Object[]{"2748563"};//938022,
		String ret = (String)call.invoke(params);
		System.out.println(ret);
	}
...
//	* @param nodeId 节点ID
	...
	public void testGetWorkflowTaskActors() throws Exception  {
		...
		Object[] params = new Object[]{"2748219","2748563","2748253"};//938022,
		String ret = (String)call.invoke(params);
		System.out.println(ret);
	}
	@Test

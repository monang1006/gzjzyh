...
/**
	Parent Exception class for all exceptions thrown from jSMSEngine API.
	Please look at the individual subclassed exceptions for information.
*/

public class jSMSEngineException extends Exception
{
	public jSMSEngineException()
	{
		super();
	}

	public jSMSEngineException(String s)
	{
		super(s);
	}
}

...
/**
	AT Hanlder for Siemens GSM devices.
*/
public class CATHandler_Siemens extends CATHandler
{
	public CATHandler_Siemens(CSerialDriver serialDriver, Logger log)
	{
	...
	{
		serialDriver.send("AT+CPMS=\"MT\"\r");

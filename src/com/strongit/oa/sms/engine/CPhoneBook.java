...
class CPhoneBook
{
	...
	private LinkedList<CPhoneBookEntry> entries;
	private LinkedList<CPhoneBookGroupEntry> groups;

	public CPhoneBook()
	{
		this.entries = new LinkedList<CPhoneBookEntry>();
		this.groups = new LinkedList<CPhoneBookGroupEntry>();
	}
	...
	protected boolean load(String file)
	{
		...
		if (file == null)
		{
			entries = new LinkedList<CPhoneBookEntry>();
			groups = new LinkedList<CPhoneBookGroupEntry>();
			loaded = true;
		}
		else
		{
	...
	protected LinkedList<COutgoingMessage> expandPhoneBookEntries(COutgoingMessage message)
	{
	...
	protected LinkedList expandPhoneBookEntries(LinkedList inList)
	{
		...
		LinkedList<COutgoingMessage> outList, tmpList;

		outList = new LinkedList<COutgoingMessage>();

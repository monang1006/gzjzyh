...
//    private String port = "COM1";  //COM口
    ...
    public static void main(String[] args){
    	String str = readSmsInSim(9600,"COM4");
    	System.out.println("############################\nstr:"+str);
//    	String str1 = str.replaceAll("\\s", "");
    	System.out.println("############################\nstr1:"+str);
    	String str2 = str.replaceAll("\\+CMGL:", ";");
    	System.out.println("############################\nstr2:"+str2);
...
//    		System.out.println(a);
    		...
    		System.out.println(pdu.getSendDate());
//    		
...
//            sendMessage(num,content);//发送短信
        ...
        System.out.println("———————————短信接受用时为 ："+(eTime-sTime));
        return res;
    }

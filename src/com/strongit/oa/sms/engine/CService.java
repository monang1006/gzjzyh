...
public class CService
{
	...
	*/
	public void readMessages(LinkedList<CIncomingMessage> messageList, int messageClass) throws Exception
	{
		int i, j, memIndex;
		...
		if (getConnected())
		{
            ...
            try { Thread.sleep(3000); } catch (Exception e) {}//等待模塊響應

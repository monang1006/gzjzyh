...
public class util
{
	...
	//	out = m_response.getWriter();
		...
		eWebEditorPath = getEditorRootRealPath(m_request.getServletPath());

		String sConfig = ReadFile(getConfigFileRealPath(m_request.getServletPath()));
	...
	//String m_contextPath=m_request.getContextPath();
		String path = m_request.getContextPath();
		//获取样式路径
		String frameroot= (String) m_request.getSession().getAttribute("frameroot");
		...
		html += "\n" + "</head>";
		html += "\n" + "<body>";
		html += "\n" + "<DIV style='OVERFLOW: auto;WIDTH: 100%;POSITION: absolute;HEIGHT: 100%;' align=center>";
		return html;
	}
	...
	public String Footer(){
		...
		html += "\n" +  "<table border=0 cellpadding=0 cellspacing=0 align=center width='100%'>" +
			...
			"<tr>" +
				"<td align=center>Copyright  &copy;  2003-2011  <b>eWebEditor<font color=#CC0000>.net</font></b> <b>eWebSoft<font color=#CC0000>.com</font></b>, All Rights Reserved .</td>" +
			"</tr>" +
			"<tr>" +
	...
	public String getConfigFileRealPath(String s_ServletPath){
		return getRealPathFromRelative(s_ServletPath, "jsp/config.jsp");
	}

	public String getRealPathFromRelative(String s_ServletPath, String s_RelativePath){
		...
		String s_EditorRoot = getEditorRootRealPath(s_ServletPath);
		...
		return s_PrePath + s_FileSeparator + s_Url;
	}

	public String getEditorRootRealPath(String s_ServletPath){
		String s_FileSeparator = System.getProperty("file.separator");
		
		String s_Path = s_ServletPath;
	...
	public String getSiteRootRealPath(){
		String s_ClassPath = this.getClass().getResource("").getPath();
		int n_Pos = s_ClassPath.lastIndexOf("WEB-INF");
		return s_ClassPath.substring(0,n_Pos);
	}
	...
	public String GetDomain(){
		String s_Url = m_request.getRequestURL().toString().toLowerCase();
		boolean b = false;
		int n = s_Url.indexOf("://");
		if (n>0){
	...
	public void GoLicense(){
		out.print("<script type='text/javascript'>alert('未授权：需要输入正版授权序列号后才可使用！');location.href='modilicense.jsp';</script>");
	}

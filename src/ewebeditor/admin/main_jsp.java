...
public class main_jsp
{
	...
	public final void Load(PageContext pagecontext) throws ServletException,IOException{
		...
		"<tr><th colspan=2>eWebEditor 7.3 版权、常用联系方法、技术支持</th></tr>"+
		"<tr>"+
			"<td width='15%'>软件版本：</td>"+
			"<td width='85%'>eWebEditor Version 7.3 for JSP 简体中文商业版</td>"+
		"</tr>"+
		"<tr>"+
			"<td width='15%'>版权所有：</td>"+
		...
		if (myUtil.sLicense.equals("")){
			out.print("<span class=red>未授权</span> [<a href='modilicense.jsp'>设置授权序列号</a>]");
		}else{
			out.print("<iframe name=ifrLicense src='' style='width:100%;height:20px;margin:0' scrolling='no' frameborder=0></iframe>"+
				...
				"<input type=hidden name='d_version' value='7.3'>"+
				"</form>"+
				"</div>"+
